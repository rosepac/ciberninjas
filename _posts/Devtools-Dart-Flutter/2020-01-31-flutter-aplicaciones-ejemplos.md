...
Esta no es una lista exhaustiva de muestras, y solo porque un proyecto no esté en la lista no significa que no valga la pena explorarlo. Del mismo modo, aunque el equipo de Flutter trabaja para mantener esta lista actualizada, hay muchos otros creados por la comunidad, como [Awesome Flutter](https://github.com/Solido/awesome-flutter){:target="_blank" rel="nofollow"} de @Solido.

## Metalistas

### [Flutter Ejemplos](https://github.com/nisrulz/flutter-examples){:target="_blank" rel="nofollow"}
...
### [Flutter Ejemplos Aplicaciones](https://github.com/iampawan/FlutterExampleApps){:target="_blank" rel="nofollow"}
...
### [Flutter por Ejemplos](https://github.com/mjohnsullivan/flutter-by-example){:target="_blank" rel="nofollow"}
...
### [Flutter por Ejemplos Web](https://github.com/flutter/samples/blob/master/web){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*

Una colección de muestras de Flutter estructuradas como Flutter para proyectos web. Si lo deseas, puedes verlos en acción [👉 🎬](https://flutter.github.io/samples){:target="_blank" rel="nofollow"}.

## Arquitectura / redes / backend

### [Arquitectura de Flutter Ejemplos](https://github.com/brianegan/flutter_architecture_samples){:target="_blank" rel="nofollow"}
...
### [jsonexample](https://github.com/flutter/samples/blob/master/jsonexample){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [provider_counter](https://github.com/flutter/samples/blob/master/provider_counter){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [provider_shopper](https://github.com/flutter/samples/blob/master/provider_shopper){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
## Interfaz de Usuario
### [Veggie Seasons](https://github.com/flutter/samples/blob/master/veggieseasons){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [Flutter UI Kit](https://github.com/iampawan/Flutter-UI-Kit){:target="_blank" rel="nofollow"}

Otra muestra de Flutter GDE Pawan Kumar, este repositorio incluye una variedad de ejemplos de IU pulidos.

### [FlutterPlayground](https://github.com/ibhavikmakwana/FlutterPlayground){:target="_blank" rel="nofollow"}
...
### [Diseño de Plataforma](https://github.com/flutter/samples/blob/master/platform_design){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [Ejemplos de Animación](https://github.com/flutter/samples/blob/master/animations){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [Place tracker](https://github.com/flutter/samples/blob/master/place_tracker){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [Flutter, mapas, y Cloud Firestore](https://github.com/flutter/samples/blob/master/flutter_maps_firestore){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*

Esta aplicación muestra el uso de un mapa de Google con datos cargados desde Cloud Firestore. Fue [construido en vivo](https://www.youtube.com/watch?v=RpQLFAFqMlw){:target="_blank" rel="nofollow"} sobre el escenario del evento Cloud Next '19.

## Aplicaciones Completas

### [Son todo Widgets](https://itsallwidgets.com/?open_source=true){:target="_blank" rel="nofollow"}
...
### [inKino](https://github.com/roughike/inKino){:target="_blank" rel="nofollow"}

Un cliente de Finnkino no oficial que muestra películas y horarios de los cines Finnkino en Finlandia. Utiliza Redux, tiene un conjunto completo de pruebas y comparte el 40% de su código entre la aplicación Flutter y la aplicación web creada sobre Angular y Dart. Actualmente está disponible en la [App Store](https://itunes.apple.com/gb/app/inkino/id1367181450?mt=8){:target="_blank" rel="nofollow"}, [Play Store](https://play.google.com/store/apps/details?id=com.roughike.inkino){:target="_blank" rel="nofollow"} y como [Aplicación Web Progresiva](https://inkino.app/){:target="_blank" rel="nofollow"}.

### [FlutterFlip](https://github.com/redbrogdon/flutterflip){:target="_blank" rel="nofollow"}
...
### [Shrine](https://github.com/flutter/samples/blob/master/gallery/gallery/lib/studies/shrine){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
### [Flutter Gallery](https://github.com/flutter/samples/blob/master/gallery){:target="_blank" rel="nofollow"} *(Equipo de Flutter)*
...
**Fuente**: [Github Flutter](https://github.com/flutter/samples/blob/master/INDEX.md){:target="_blank" rel="nofollow"}
{: .notice--info}
