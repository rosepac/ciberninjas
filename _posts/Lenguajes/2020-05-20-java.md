...
header:
  teaser: /assets/images/lenguajes/desarrollador-java.webp
  overlay_image: /assets/images/lenguajes/desarrollador-java.webp
  overlay_filter: 0.2
  image_description: 'Cómo aprender Java desde cero a experto en 2020, todo lo necesario para ayudarte a convertirte en un profesional.'
  image_alt: 'Cómo aprender Java desde cero a experto en 2020, todo lo necesario para ayudarte a convertirte en un profesional.'
title: '▷ Cómo Aprender Java en 2020 🐍'
description: >-
  Cómo aprender Java desde cero a experto en 2020, todo lo necesario para ayudarte a convertirte en un profesional.
excerpt: >-
  Cómo aprender Java desde cero a experto en 2020, todo lo necesario para ayudarte a convertirte en un profesional.
...
[¿Qué es Java?](/java/#qu%c3%a9-es-java){: .btn .btn--inverse .btn--large} [Historia de Java](/java/#historia-de-java){: .btn .btn--inverse .btn--large} [¿Por qué aprender Java?](/java/#por-qu%c3%a9-aprender-java){: .btn .btn--inverse .btn--large} [Características de Java](/java/#caracter%c3%adsticas-de-java){: .btn .btn--inverse .btn--large} [Qué es la Plataforma Java](/java/#qu%c3%a9-es-la-plataforma-java){: .btn .btn--inverse .btn--large} [Componentes de Java](/java/#componentes-de-java){: .btn .btn--inverse .btn--large} [Comenzar con Java](/java/#est%c3%a1s-preparado-para-comenzar-con-java){: .btn .btn--inverse .btn--large}

Sí, ¡Vamos a aprender Java! Java es un lenguaje de programación orientado a objetos que se basa en el concepto de Sistemas de programación orientada a objetos (OOPS). Todo en Java es sobre objetos. Si obtienes la esencia de los objetos, Java es tan simple y agradable como comer tu comida favorita.

Bien, pero 

## **Qué es Java?**

Java es un lenguaje de programación de escritura única y ejecución en cualquier lugar desarrollado por Sun Microsystems. Es similar a C y C ++ pero mucho más fácil.

Además, se puede combinar Java con muchas tecnologías como Spring, node js, Android, Hadoop, J2EE, etc. para crear aplicaciones completas, robustas, escalables, portátiles y distribuidas. Java también promueve la integración continua y las pruebas utilizando herramientas como Selenium.
...
[James Gosling](/personajes-historicos/james-gosling/) desarrolló originalmente Java con sus colegas de Sun Microsystems a principios de la década de 1990. Inicialmente, se llamó un proyecto 'Oak' que tenía una implementación similar a C y C ++ . El nombre que Java seleccionó más tarde después de una lluvia de ideas suficiente y se basa en el nombre de un grano de espresso. Java 1.0, la primera versión fue lanzada en 1995 con el lema de 'escribir una vez, ejecutar en cualquier lugar'. Más tarde, Oracle adquirió Sun Microsystems. A partir de ahí, no ha habido vuelta atrás. La última versión de Java es Java 12 lanzada en marzo de 2019.
...
Como Java es seguro y multiproceso, es perfecto para los servicios de gestión de transacciones y banca . Las tiendas de comercio electrónico y el software de facturación tienen su lógica escrita en marcos basados ​​en Core Java. El sistema operativo móvil como Android utiliza API de Java. Los algoritmos del mercado de valores se basan en Java. Y más recientemente, todos los grandes datos : los enormes datos se tratan como una brisa con Java. De hecho, el marco MapReduce de Hadoop está escrito en Java. Java junto con otros marcos como Spring crea una combinación robusta para ordenar las dependencias de implementación y escribir aplicaciones del lado del servidor en los dominios de Finanzas y TI .
...
- Amplia biblioteca estándar que facilita la codificación. Puede crear una aplicación independiente completa utilizando Java.
...
Esto significa que no necesita compiladores individuales específicos de la máquina para que se ejecute el código Java. Es por eso que Java también se llama *plataforma*. El lenguaje de programación Java es *diferente*desde la plataforma Java.
...
Hay cuatro plataformas Java del lenguaje de programación Java:
...
#### Índice <!-- omit in toc -->
- [**Qué es Java?**](#qu%c3%a9-es-java)
- [**Historia de Java**](#historia-de-java)
- [**Por qué aprender Java?**](#por-qu%c3%a9-aprender-java)
- [**Características de Java**](#caracter%c3%adsticas-de-java)
- [**Qué es la plataforma Java?**](#qu%c3%a9-es-la-plataforma-java)
- [**Componentes de Java**](#componentes-de-java)
- [**Estás preparado para comenzar con Java?**](#est%c3%a1s-preparado-para-comenzar-con-java)
  - [**Un resumen rápido**](#un-resumen-r%c3%a1pido)
