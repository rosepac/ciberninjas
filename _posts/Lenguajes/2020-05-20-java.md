...
title: '▷ ¿Que es Java? Una guía para principiantes sobre Java y su función'
header:
...
description: >-
  ¿Que es Java? Java es un lenguaje de programación de escritura única y ejecución en cualquier lugar desarrollado por Sun Microsystems.
excerpt: >-
  ¿Que es Java? - Java es un lenguaje de programación de escritura única y ejecución en cualquier lugar desarrollado por Sun Microsystems.
