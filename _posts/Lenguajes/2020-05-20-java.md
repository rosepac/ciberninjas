...
title: '🥇 ▷ ¿Qué es Java? Guía rápida para principiantes del lenguaje de programación Java'
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Aprender Java</li>
  </ol>
</nav>
</div>
...
<span id="menu"><strong>MENÚ DE LA GUÍA DE APRENDIZAJE JAVA</strong></span>

- [**¿Qué es Java?**](#qué-es-java)
- [**¿Por qué aprender Java?**](#por-qué-aprender-java)
- [**¿Qué es el IDE en Java?**](#qué-es-el-ide-en-java)
- [**¿Por qué utilizar Java IDE?**](#por-qué-utilizar-java-ide)
- [**¿Cuál es la historia de Java?**](#cuál-es-la-historia-de-java)
- [**¿Cuáles son las características de Java?**](#cuáles-son-las-características-de-java)
- [**¿Qué es la plataforma Java?**](#qué-es-la-plataforma-java)
- [**¿Cuáles son los componentes de Java**](#cuáles-son-los-componentes-de-java)
...
[🔝 Ir al Menú](/java/#menu){: .btn .btn-outline-dark .btn-lg .btn-block}
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Java es un lenguaje de programación basado en clases y orientado a objetos, diseñado para tener la menor cantidad de dependencias de implementación posibles."
    }
  },{
    "@type": "Question",
    "name": "¿Por qué aprender Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Java es seguro y multiproceso, es perfecto para los servicios de gestión de transacciones y banca, además el sistema operativo móvil como Android utiliza la API de Java."
    }
  },{
    "@type": "Question",
    "name": "¿Cuál es la historia de Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "El creador de Java es James Gosling. Gosling desarrolló originalmente Java con sus compañeros de Sun Microsystems a principios de la década de 1990, puedes seguir.."
    }
  },{
    "@type": "Question",
    "name": "¿Cuáles son las características de Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Las características principales de Java son, que es un lenguaje independiente de su plataforma, posee una amplia biblioteca estándar y además ofrece un gran rendimiento."
    }
  },{
    "@type": "Question",
    "name": "¿Qué es la plataforma Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "La plataforma Java es una plataforma solo de software bastante diferente de las plataformas tradicionales como Windows, Mac, Linux o Solaris."
    }
  },{
    "@type": "Question",
    "name": "¿Cuáles son los componentes de Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Java está formado por 3 componentes principales: JVM, JDK y JRE. La máquina virtual de Java, las herramientas de desarrollo de Java y la instancia de ejecución de Java."
    }
  },{
    "@type": "Question",
    "name": "¿Estás preparado para comenzar con Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Antes de comenzar con la programación en Java, debes familiarizarte con las clases más utilizadas en Java como por ejemplo: Class, public, static, void, int ,string, etc."
    }
  },{
    "@type": "Question",
    "name": "¿Qué es el IDE de Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "El IDE de Java es una aplicación que ofrece amplias instalaciones a los programadores para el desarrollo de software. Un IDE generalmente contiene un editor de código fuente, un depurador y herramientas de automatización de compilación."
    }
  },{
    "@type": "Question",
    "name": " ¿Por qué utilizar el IDE de Java?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "El IDE de Java proporciona una plantilla de código confeccionada, esta herramienta valida automáticamente la sintaxis, es compatible con la refactorización de código, admite la coloración de sintaxis, te permite establecer puntos de interrupción, ofrece un depurador robusto, editor de Java robusto."
    }
  }]
}
</script>