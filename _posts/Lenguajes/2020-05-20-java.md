...
header:
  ...
  overlay_filter: 0.2
  image_description: 'Cómo aprender Java desde cero a experto en 2020, todo lo necesario para convertirte en un profesional.'
  image_alt: 'Cómo aprender Java desde cero a experto en 2020, todo lo necesario para convertirte en un profesional.'
title: '▷ Cómo Aprender Java en 2020 🐍'
description: >-
  Cómo aprender Java desde cero a experto en 2020, todo lo necesario para convertirte en un profesional.
excerpt: >-
  Cómo aprender Java desde cero a experto en 2020, todo lo necesario para convertirte en un profesional.
...
[James Gosling](/personajes-historicos/james-gosling/) desarrolló originalmente Java con sus colegas de Sun Microsystems a principios de la década de 1990. Inicialmente, se llamó un proyecto 'Oak' que tenía una implementación similar a C y C ++ .

El nombre que Java seleccionó más tarde después de una lluvia de ideas suficiente y se basa en el nombre de un grano de espresso. Java 1.0, la primera versión fue lanzada en 1995 con el lema de 'escribir una vez, ejecutar en cualquier lugar'.

Más tarde, Oracle adquirió Sun Microsystems. A partir de ahí, no ha habido vuelta atrás. La última versión de Java es Java 12 lanzada en marzo de 2019.
