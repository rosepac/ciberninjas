...
## **¿Qué otra información debo conocer a la hora de comprar Fire TV Cube?**

- El cable HDMI se vende por separado. Se requieren un cable HDMI de alta velocidad y televisor 4K con puerto HDMI de alta velocidad para ver contenido en 4K.
...
| -------------------------------------- | ------------------------------------------------------------ |
| **Peso**                               | 465 g. *Las dimensiones y el peso reales pueden variar en función del proceso de configuración y fabricación.* |
| **Procesador**                         | Hexa-Core (Quad-Core a 2,2 GHz como máximo y Dual-Core a 1,9 GHz como máximo) |
| **GPU**                                | ARM Mali G52-MP2 (3EE), 800 MHz                              |
| **Almacenamiento**                     | 16 GB interno                                                |
| **Memoria RAM**                        | 2 GB                                                         |
| **Conectividad wifi**                  | Wifi de doble banda y doble antena (MIMO) que permite una transferencia de datos más rápida y una pérdida de conexión menor que con el wifi estándar. Compatible con redes wifi 802.11a/b/g/n/ac. |
| **Bluetooth**                          | Bluetooth 5.0 y LE. Se puede vincular con altavoces, auriculares, mandos de videojuegos y otros dispositivos Bluetooth compatibles. |
| **Compatibilidad de voz**              | Compatibilidad con voz de largo y corto alcance              |
| **Compatibilidad del control por voz** | El Fire TV Cube puede controlar un amplio rango de dispositivos compatibles con IR integrado, como televisores, barras de sonido, decodificadores de TV por cable y receptores AV. [Más información](https://www.amazon.es/l/21271280031) sobre dispositivos compatibles. |
| **Almacenamiento en el Cloud**         | Almacenamiento gratuito en el Cloud para el contenido digital comprado en Amazon |
| **Puertos**                            | HDMI, alimentación, micro USB y compatibilidad con infrarrojos mediante cable |
| **Audio incluido**                     | Altavoz de 1,6 pulgadas (40 mm) integrado para interactuar con Alexa incluso cuando el televisor está apagado. El Fire TV Cube usa los altavoces de tu sistema de entretenimiento a fin de reproducir contenido y, para ello, activará el televisor, la barra de sonido o el receptor AV. |
| **Compatibilidad de audio**            | Dolby Atmos, sonido envolvente 7.1, estéreo de 2 canales y pass-through a través de HDMI (hasta 5.1) |
| **Formatos de contenido compatibles**  | Vídeo: Dolby Vision, HDR 10, HDR10+, HLG, H.265, H.264 y VP9. Audio: AAC-LC, AC3, eAC3 (Dolby Digital Plus), FLAC, MP3, PCM/Wave, Vorbis y Dolby Atmos (EC3_JOC). Imagen: JPEG, PNG, GIF y BMP |
| **Resolución de salida compatible**    | 2160p, 1080p y 720p hasta a 60 FPS                           |
| **Requisitos del sistema**      | Televisor de alta definición con entrada HDMI de alta velocidad, cable HDMI, conexión a Internet de alta velocidad a través de wifi o a través del adaptador Ethernet incluido en la caja, y toma de corriente. El equipamiento de TV, sonido o TV por cable que se quiera controlar mediante infrarrojos o voz debe ser compatible. Se requieren un cable HDMI de alta velocidad y televisor 4K con puerto HDMI de alta velocidad para ver contenido en 4K. |
| ------------------------------- | ------------------------------------------------------------ |
| **Televisores compatibles**     | El televisor debe ser compatible con los requisitos mínimos de HDCP para la reproducción de contenido protegido. Compatible con 1) televisores de alta definición 4K con entrada HDMI y capacidad para 1080p a 24/25/30/50/60 Hz y HDCP 2.2, o 2) televisores de alta definición con entrada HDMI y capacidad para 1080p o 720p a 50/60 Hz. [Más información](https://www.amazon.es/l/21271280031). |
| **Garantía y servicio**         | El Fire TV Cube se vende con una [garantía limitada de 1 año](https://www.amazon.es/gp/help/customer/display.html?nodeId=201311110) proporcionada por el fabricante. Esta garantía limitada es complementaria a tus derechos como consumidor y no supone ningún perjuicio para dichos derechos. Esto quiere decir que es posible que tengas derechos adicionales según la ley vigente incluso una vez haya expirado la garantía limitada (para obtener más información respecto a tus derechos como consumidor, [haz clic aquí](https://www.amazon.es/gp/help/customer/display.html?nodeId=201310960)). El uso del Fire TV Cube está sujeto a los términos descritos [aquí](https://www.amazon.es/gp/help/customer/display.html?nodeId=201267340). |
