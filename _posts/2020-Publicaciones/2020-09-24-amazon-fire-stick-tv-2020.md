...
## **Conociendo más el nuevo Fire Stick TV**
...
### **Claridad de sonido mejorada de Dolby Atmos** <!-- omit in toc -->
...
### **Mando por voz Alexa con controles del TV** <!-- omit in toc -->
...
### **Encuentra contenido rápidamente** <!-- omit in toc -->
...
### **Miles de películas y capítulos de series** <!-- omit in toc -->
...
### **Mira televisión en directo y televisión gratis** <!-- omit in toc -->
...
### **Diseño discreto: conéctalo y que empiece la diversión** <!-- omit in toc -->
...
### **La televisión es solo el principio** <!-- omit in toc -->
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Peso**                                                     | 32,0 g. *Las dimensiones y el peso reales pueden variar en función del proceso de configuración y fabricación.* |
| **Procesador**                                               | Quad-Core de 1,7 GHz                                         |
| **GPU**                                                      | IMG GE8300                                                   |
| **Almacenamiento**                                           | Almacenamiento interno de 8 GB (la capacidad formateada real puede ser inferior) para guardar apps y juegos |
| **Wifi**                                                     | Wifi de doble banda y doble antena (MIMO) que permite un transferencia de datos más rápida y pérdida de conexión menor que con el wifi estándar. Compatible con redes wifi 802.11a/b/g/n/ac. |
| **Bluetooth**                                                | Bluetooth 5.0 y Bluetooth Low Energy. Se puede vincular con altavoces, auriculares, mandos de videojuegos y otros dispositivos Bluetooth compatibles. |
| **Compatibilidad de voz**                                    | Sí, con el mando por voz Alexa (incluido) o la app Fire TV gratuita (disponible para descarga en Fire OS, iOS y Android) |
| **Control de dispositivos por infrarrojos con el mando por voz Alexa incluido** | Con el mando por voz Alexa, incluido en la caja, puedes controlar el Amazon Fire TV Stick y determinadas funciones (como el encendido y el volumen) de una amplia gama de dispositivos con tecnología de infrarrojos compatibles, como TV, barras de sonido y receptores de AV. Nota: Es posible que determinadas funciones no estén disponibles en algunos dispositivos con tecnología de infrarrojos. |
...
| **Televisores compatibles**          | TV HD con HDMI y capacidad para 1080p o 720p a 60/50 Hz      |
| **Garantía y servicio**              | El Fire TV Stick se vende con una garantía limitada de un año proporcionada por el fabricante. Esta garantía limitada es complementaria a tus derechos como consumidor y no supone ningún perjuicio para dichos derechos. Esto quiere decir que quizás tengas derechos adicionales según la ley aplicable incluso una vez expirada la garantía limitada. |
| **Compatibilidad según región**      | Es posible que algunos servicios no estén disponibles fuera de España |
| **Funcionalidades de accesibilidad** | Lector de pantalla VoiceView que permite el acceso a la mayoría de las funciones del Fire TV a usuarios invidentes o con problemas de visión. La lupa permite ampliar y reducir la imagen, así como desplazarse por la pantalla. El banner de texto muestra todo el texto que aparece en la pantalla en un recuadro compacto y personalizable. Reproducción de vídeos y episodios de series con subtítulos. Usa la audiodescripción para escuchar descripciones orales de lo que pasa en la pantalla, incluyendo acciones físicas, expresiones faciales y cambios de escena. Los subtítulos y la audiodescripción en audio no están disponibles para todo el contenido. Escucha contenido del Fire TV con auriculares Bluetooth compatibles.. |
| **Contenido de la caja**             | Fire TV Stick (3.ª generación), mando por voz Alexa (2.ª generación), cable USB y adaptador de corriente, extensión HDMI, 2 pilas AAA y Guía de inicio rápido. |

Mando por Voz Alexa de 2ª Generación

| **Dimensiones** | 38 x 142 x 16 mm                                             |
| --------------- | ------------------------------------------------------------ |
| **Peso**        | 43,4 g (sin pilas). *Las dimensiones y el peso reales pueden variar en función del proceso de configuración y fabricación.* |
