...
**Jenkins** es un servidor de integración continua de código abierto capaz de organizar una cadena de acciones que ayudan a lograr el proceso de integración continua (y mucho más) de manera automatizada. Es una aplicación crear para trabajar contra un servidor y por tanto, requiere un servidor web como por ejemplo: Apache Tomcat.
