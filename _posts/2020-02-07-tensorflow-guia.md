...
* Ayuda a que los componentes API se integren mejor con [tf.keras](https://www.tensorflow.org/api_docs/python/tf/keras){:target="_blank"} (una interfaz de alto nivel para redes neuronales que se ejecuta sobre múltiples backends).
* Incluye la versión 1.0 de [TensorFlow.js](https://www.tensorflow.org/js){:target="_blank"}, que permite el uso de modelos JavaScript estándar, puede volver a capacitar los modelos JS existentes y permite la construcción y capacitación de modelos directamente en JavaScript.
* Incluye [TensorFlow Federated](https://www.tensorflow.org/federated){:target="_blank"}, que es un framework de código abierto para experimentar con el aprendizaje automático (y otros cálculos) utilizando datos descentralizados.
* Incluye [TF Privacy](https://github.com/tensorflow/privacy){:target="_blank"}, una biblioteca para entrenar modelos de aprendizaje automático con un enfoque en la privacidad para los datos de entrenamiento.
* Presenta una [ejecución entusiasta](https://www.tensorflow.org/guide/eager){:target="_blank"}, que es un entorno de programación imperativo que evalúa las operaciones de inmediato, sin crear gráficos antes de devolver valores concretos.
* Utiliza [tf.function](https://www.tensorflow.org/alpha/tutorials/eager/tf_function){:target="_blank"}, que le permite transformar un subconjunto de sintaxis de Python en gráficos portátiles de alto rendimiento y mejora el rendimiento y la capacidad de implementación de una ejecución ansiosa.
* La experimentación avanzada será posible con nuevas extensiones de [Tensores irregulares](https://www.tensorflow.org/guide/ragged_tensors){:target="_blank"} (el equivalente TensorFlow de listas anidadas de longitud variable), [TensorFlow Probability](https://www.tensorflow.org/probability){:target="_blank"} (una biblioteca de Python construida en TensorFlow que facilita la combinación de modelos probabilísticos y aprendizaje profundo) y [Tensor2Tensor](https://github.com/tensorflow/tensor2tensor){:target="_blank"} (una biblioteca de modelos de aprendizaje profundo y conjuntos de datos).
...
Debido a que Google hizo de código abierto TensorFlow, las bibliotecas pueden ser a la vez mejorado y ampliado a otros idiomas, tales como [Java](https://www.java.com/){:target="_blank"}, [Lua](https://www.lua.org/){:target="_blank"}, y [R](https://www.r-project.org/about.html){:target="_blank"}. Este movimiento lleva el aprendizaje automático (algo que hasta ahora solo estaba disponible para los institutos de investigación) a todos los desarrolladores, para que puedan enseñar a sus sistemas y software a reconocer imágenes o traducir el habla.
...
TensorFlow se lanzó originalmente el 9 de noviembre de 2015, y la versión estable se puso a disposición el 15 de febrero de 2017. [TensorFlow 2.0 alpha ya](https://www.tensorflow.org/alpha){:target="_blank"} está disponible, y la vista previa pública estará disponible próximamente. Puede obtener más información sobre el alfa TensorFlow 2.0 en la [guía](https://www.tensorflow.org/alpha/tutorials/quickstart/beginner){:target="_blank"} oficial [Comenzar con TensorFlow](https://www.tensorflow.org/alpha/tutorials/quickstart/beginner){:target="_blank"} .

Las [bibliotecas](https://github.com/jtoy/awesome-tensorflow#libraries){:target="_blank"} , las [API](https://www.tensorflow.org/api_docs/){:target="_blank"} y [las guías de desarrollo](https://www.tensorflow.org/get_started/get_started){:target="_blank"} están disponibles ahora, por lo que los desarrolladores pueden comenzar a incluir TensorFlow en sus productos. Los usuarios ya están viendo los resultados de TensorFlow en Google Photos, Gmail, Google Search, Google Assistant y más.

## Competidores de TensorFlow

TensorFlow no está solo en el campo de aprendizaje profundo; de hecho, hay varias otras empresas con frameworks de aprendizaje automático, incluidas las siguientes [bibliotecas de Python](/python/#bibliotecas-de-python) como [Theano](/python/#theano), [Keras](/python/#keras), [Pandas](/python/#pandas), etc. Entre algunas otras librerías aún no citadas como por ejemplo [Torch](https://github.com/torch/torch7){:target="_blank"}, [Caffe](https://github.com/BVLC/caffe){:target="_blank"}, [neon](https://github.com/NervanaSystems/neon){:target="_blank"} o [H2O.ai](https://www.h2o.ai/){:target="_blank"}

## ¿Cómo empiezo a usar TensorFlow?

Lo primero que debe hacer cualquier desarrollador es leer la [guía de inicio de TensorFlow](https://www.tensorflow.org/get_started/get_started){:target="_blank"}, que incluye un tutorial básico de TensorFlow. Si es nuevo en el aprendizaje automático, asegúrese de consultar las siguientes guías:

* [MNIST para principiantes de ML](https://www.tensorflow.org/get_started/mnist/beginners){:target="_blank"}
* [MNIST profundo para expertos](https://www.tensorflow.org/get_started/mnist/pros){:target="_blank"}

Los desarrolladores pueden [instalar TensorFlow](https://www.tensorflow.org/install/){:target="_blank"} en Linux, Mac y Windows (o incluso instalar desde la fuente), o consultar sus diversas herramientas desde la [página](https://github.com/tensorflow){:target="_blank"} oficial de [TensorFlow GitHub](https://github.com/tensorflow){:target="_blank"}.

Finalmente, los desarrolladores pueden aprovechar todas las guías de TensorFlow:

* [TensorFlow Mechanics 101](https://www.tensorflow.org/get_started/mnist/mechanics){:target="_blank"}
* [tf.contrib.learn Inicio rápido](https://www.tensorflow.org/get_started/tflearn){:target="_blank"}
* [Creación de funciones de entrada con tf.contrib.learn](https://www.tensorflow.org/get_started/input_fn){:target="_blank"}
* [TensorBoard: Visualizando el aprendizaje](https://www.tensorflow.org/get_started/summaries_and_tensorboard){:target="_blank"}
* [TensorBoard: visualización de incrustación](https://www.tensorflow.org/get_started/embedding_viz){:target="_blank"}
* [TensorBoard: visualización de gráficos](https://www.tensorflow.org/get_started/graph_viz){:target="_blank"}
* [Conceptos básicos de registro y monitoreo con tf.contrib.learn](https://www.tensorflow.org/get_started/monitors){:target="_blank"}
...
**Fuente**\: [Tech Republic](https://www.techrepublic.com/article/tensorflow-googles-open-source-software-library-for-machine-learning-the-smart-persons-guide/){:target="_blank"}
{: .notice--info}