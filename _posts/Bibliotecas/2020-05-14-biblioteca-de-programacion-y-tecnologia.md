...
El primer lenguaje de programación de computadoras fue creado en 1883, cuando una mujer llamada Ada Lovelace trabajó con Charles Babbage en su primera computadora mecánica, el motor analítico. Mientras que a Babbage le preocupaba simplemente calcular números, Lovelace vio que los números con los que trabajaba la computadora podían representar algo más que cantidades de cosas. Ella escribió un algoritmo para el motor analítico que fue el primero de su tipo. Debido a su contribución, se le atribuye a Lovelace la creación del primer lenguaje de programación de computadoras. A medida que surgieron diferentes necesidades y se crearon nuevos dispositivos, se siguieron muchos más idiomas.

- 1883: Algoritmo para el motor de analítico,  creado por Ada Lovelace para el motor analítico de Charles Babbage para calcular los números de Bernoulli, se considera el primer lenguaje de programación de computadoras.
- 1949: Lenguaje ensamblador, primero utilizado ampliamente en la calculadora automática de almacenamiento electrónico de retardo, el lenguaje ensamblador es un tipo de lenguaje de programación de computadora de bajo nivel que simplifica el lenguaje del código de máquina, las instrucciones específicas necesarias para indicarle a la computadora qué hacer.
- 1952: Autocode fue un término genérico para una familia de lenguajes de programación de computadoras tempranos. El primero fue desarrollado por Alick Glennie para la computadora Mark 1 de la Universidad de Manchester en el Reino Unido. Algunos consideran que el código automático es el primer lenguaje de programación compilado, lo que significa que se puede traducir directamente al código de la máquina usando un programa llamado compilador.
- 1957: Fortran, un lenguaje de programación creado por John Backus para trabajos científicos, matemáticos y estadísticos complicados, Fortran significa For mula Tran slation. Es uno de los lenguajes de programación de computadoras más antiguos que todavía se usan en la actualidad.
...
- 1972: SQL, SQL fue desarrollado por Donald D. Chamberlin y Raymond F. Boyce en IBM. SQL significa S tructured Q uery L anguage. Se utiliza para ver y cambiar la información que se almacena en las bases de datos. SQL usa oraciones de comando llamadas consultas para agregar, eliminar o ver datos.
...
* [Documentación de SQL Server 2017](https://docs.microsoft.com/es-es/sql/sql-server/sql-server-technical-documentation?view=sql-server-2017){:target="_blank" rel="nofollow"} (HTML) por Microsoft
...
* [Redis: Un pequeño libro](https://raulexposito.com/documentos/redis/redis.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [La Cuarta Revolución Industrial Está Aquí - ¿Está usted preparado?](https://www2.deloitte.com/content/dam/Deloitte/co/Documents/about-deloitte/Revoluci%C3%B3n%204.0%20142201.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [La crisis del modelo de derecho de autor y las prácticas para democratizar la cultura](https://vialibre.org.ar/arcopy.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [Implementación de Servidores con GNU/Linux](https://fortinux.com/wp-content/uploads/2010/12/Implementacion_Servidores_Linux_LR.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [97 cosas que todo programador debería saber](https://97cosas.com/programador){:target="_blank" rel="nofollow"} (HTML)
...
* [Glosario de términos y conceptos de robótica](http://el.uy/doc/robotica/mooc.educalab.es.%202017.%20Glosario%20de%20t%C3%A9rminos%20y%20conceptos%20rob%C3%B3ticos.pdf){:target="_blank" rel="nofollow"} (MOOC Intef)
...
* [Manual básico de programación en C++](https://olimpiada-informatica.org/static/pdfs/manual.es.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [Lenguaje Ensamblador para PC](https://pacman128.github.io/static/pcasm-book-spanish.pdf){:target="_blank" rel="nofollow"} - Paul A.Carter (PDF)

### Erlang <i class="fab fa-erlang"></i>

* [Programación en Erlang](https://es.wikibooks.org/wiki/Programaci%C3%B3n_en_Erlang){:target="_blank" rel="nofollow"} (WikiLibros)

### Elixir

* [Elixir School. Lecciones acerca del lenguaje de programación Elixir](https://elixirschool.com/es){:target="_blank" rel="nofollow"}

[🔝 Inicio](/biblioteca-de-programacion-y-tecnologia/#-meta-listas){: .btn .btn--inverse .btn--large}

## Git <i class="fab fa-git"></i>

* [Git Immersion en Español](https://esparta.github.io/gitimmersion-spanish){:target="_blank" rel="nofollow"}
* [Git Magic (2007)](https://openlibra.com/es/book/download/git-magic){:target="_blank" rel="nofollow"}
* [Git. Fundamentos](https://www.jesusamieiro.com/wp-content/uploads/2015/10/Guion_comandos.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Git. La guía simple](https://rogerdudler.github.io/git-guide){:target="_blank" rel="nofollow"} (HTML)
* [Gitmagic](https://www-cs-students.stanford.edu/~blynn/gitmagic/intl/es){:target="_blank" rel="nofollow"}
* [Pro Git](https://git-scm.com/book/es/){:target="_blank" rel="nofollow"}

## Github <i class="fab fa-github"></i>

* [Conociendo Github Documentación](https://media.readthedocs.org/pdf/conociendogithub/latest/conociendogithub.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Github Simple](https://github.com/MrOutis/GitHub-Simple#github-simple){:target="_blank" rel="nofollow"} (Github)

### Go

* [Go: Un pequeño libro](https://raulexposito.com/documentos/go/go.pdf){:target="_blank" rel="nofollow"} (PDF)

### Haskell

* [¡Aprende Haskell por el bien de todos!](https://aprendehaskell.es/main.html){:target="_blank" rel="nofollow"} (HTML)
* [Lógica de primer orden en Haskell](https://docs.google.com/viewerng/viewer?url=idus.us.es/xmlui/bitstream/handle/11441/63139/Paluzo+Hidalgo+Eduardo+TFG.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Piensa en Haskell (ejercicios de programación funcional)](https://www.cs.us.es/~jalonso/publicaciones/Piensa_en_Haskell.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [CSS3 y JavaScript avanzado](https://openlibra.com/es/book/download/css3-y-javascript-avanzado){:target="_blank" rel="nofollow"} (PDF)
* [Diseño de Interfaces Web](https://interfacesweb.github.io/unidades/){:target="_blank" rel="nofollow"} (HTML)
* [Estructura con CSS](https://es.learnlayout.com){:target="_blank" rel="nofollow"} (HTML)
* [Guía Completa de CSS3](https://openlibra.com/es/book/download/guia-completa-de-css3){:target="_blank" rel="nofollow"} - Antonio Navajas (PDF)
* [HTML5](https://www.arkaitzgarro.com/html5){:target="_blank" rel="nofollow"} - Arkaitz Garro (HTML) [(PDF)](https://openlibra.com/es/book/download/html5){:target="_blank" rel="nofollow"}
* [Introducción a CSS](https://librosweb.es/libro/css/){:target="_blank" rel="nofollow"} - Javier Eguíluz (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-css){:target="_blank" rel="nofollow"}
* [Introducción a XHTML](https://librosweb.es/libro/xhtml){:target="_blank" rel="nofollow"} (HTML)
* [Sass, el manual oficial](https://librosweb.es/libro/sass/){:target="_blank" rel="nofollow"} (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-xhtml){:target="_blank" rel="nofollow"}
...
* [Notas de Introducción al Lenguaje de Programación Java (2004)](https://lya.fciencias.unam.mx/jloa/publicaciones/introduccionJava.pdf){:target="_blank" rel="nofollow"} - Jorge L. Ortega Arjona (PDF)
* [Pensando la computación como un científico (con Java)](https://www.ungs.edu.ar/cm/uploaded_files/publicaciones/476_cid03-Pensar%20la%20computacion.pdf){:target="_blank" rel="nofollow"} (PDF)
* [PlugIn Apache Tapestry: desarrollo de aplicaciones y páginas web](https://picodotdev.github.io/blog-bitix/assets/custom/PlugInTapestry.pdf){:target="_blank" rel="nofollow"} (PDF) [(ePub, Mobi, HTML)](https://picodotdev.github.io/blog-bitix/2014/02/libro-sobre-desarrollo-de-aplicaciones-con-apache-tapestry/){:target="_blank" rel="nofollow"}
* [Prácticas d Java (2009)](https://openlibra.com/es/book/download/practicas-de-java){:target="_blank" rel="nofollow"} (PDF)
* [Preparando JavaSun 6 - OCPJP6](https://github.com/PabloReyes/ocpjp-resumen-espanol#ocpjp6-resumen-español){:target="_blank" rel="nofollow"} - Pablo Reyes Almagro (Github) [(PDF)](https://github.com/PabloReyes/ocpjp-resumen-espanol/blob/master/OCPJP6%20Resumen.pdf){:target="_blank" rel="nofollow"}
* [Programación en Java](https://elvex.ugr.es/decsai/java){:target="_blank" rel="nofollow"} (HTML)
* [Tutorial básico de Java EE](https://static1.1.sqspcdn.com/static/f/923743/14770633/1416082087870/JavaEE.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Tutorial introducción a Maven 3](https://static1.1.sqspcdn.com/static/f/923743/15025126/1320942755733/Tutorial_de_Maven_3_Erick_Camacho.pdf){:target="_blank" rel="nofollow"} - Erick Camacho (PDF)
...
* [Jardín de JavaScript](https://bonsaiden.github.io/JavaScript-Garden/es){:target="_blank" rel="nofollow"} (HTML)
* [JavaScript, ¡Inspírate!](https://leanpub.com/javascript-inspirate){:target="_blank" rel="nofollow"} (Descarga PDF)
* [JavaScript Para Gatos](https://jsparagatos.com){:target="_blank" rel="nofollow"} (HTML)
* [Manual de JavaScript](https://desarrolloweb.com/manuales/manual-javascript.html#capitulos20){:target="_blank" rel="nofollow"} (HTML)
...
* [Tutorial de D3](https://gcoch.github.io/D3-tutorial/index.html){:target="_blank" rel="nofollow"} (HTML)

### jQuery

* [Fundamentos de jQuery](https://librosweb.es/libro/fundamentos_jquery){:target="_blank" rel="nofollow"} (HTML) [(PDF)](https://openlibra.com/es/book/download/fundamentos-de-jquery){:target="_blank" rel="nofollow"}
* [Manual de jQuery](https://mundosica.github.io/tutorial_hispano_jQuery/){:target="_blank" rel="nofollow"} (HTML)
...
* [SurviveJS - React: De aprendiz a maestro](https://leanpub.com/survivejs-react-es){:target="_blank" rel="nofollow"} (Descarga PDF)
...
* [Introducción a Programando con Python](https://opentechschool.github.io/python-beginners/es_CL/){:target="_blank" rel="nofollow"} (HTML)
...
* [Machine Learning, Python](https://jarroba.com/machine-learning-python-ejemplos){:target="_blank" rel="nofollow"} (HTML) (en proceso)
* [Notas sobre el lenguaje Python](https://www.cmat.edu.uy/cmat/cursos/licenciatura/cursos/computacion/documentos/pynotas.pdf/at_download/file){:target="_blank" rel="nofollow"} (PDF) (descarga directa)
* [Plone: Gestor de Contenidos](https://plone-spanish-docs.readthedocs.io/es/3.3.6/){:target="_blank" rel="nofollow"} (HTML)
* [Prácticas de Programación con Python](https://drive.google.com/file/d/148Zocb3X5OxGahn8gWxJ967_9MjHpgeP/view){:target="_blank" rel="nofollow"} (PDF)
* [Python instantáneo (1999)](https://www.arrakis.es/~rapto/AprendaPython.html){:target="_blank" rel="nofollow"} (HTML)
* [Python para ciencia e ingeniería](https://github.com/mgaitan/curso-python-cientifico#curso-de-python-para-ciencias-e-ingenierías){:target="_blank" rel="nofollow"} (Github)
* [Python para principiantes](https://librosweb.es/libro/python){:target="_blank" rel="nofollow"} (HTML) [(PDF)](https://web.archive.org/web/20150421012120/https://www.cursosdeprogramacionadistancia.com/static/pdf/material-sin-personalizar-python.pdf){:target="_blank" rel="nofollow"}
...
* [Cartas sobre Estadística de la Revista Argentina de Bioingeniería](https://cran.r-project.org/doc/contrib/Risk-Cartas-sobre-Estadistica.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Generacion automática de reportes con R y LaTeX](https://cran.r-project.org/doc/contrib/Rivera-Tutorial_Sweave.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Gráficos Estadísticos con R](https://cran.r-project.org/doc/contrib/grafi3.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Introducción a R](https://cran.r-project.org/doc/contrib/R-intro-1.1.0-espanol.1.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Introducción al uso y programación del sistema estadístico R](https://cran.r-project.org/doc/contrib/curso-R.Diaz-Uriarte.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Métodos Estadísticos con R y R Commander](https://cran.r-project.org/doc/contrib/Saez-Castillo-RRCmdrv21.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Optimización Matemática con R: Volúmen I](https://cran.r-project.org/doc/contrib/Optimizacion_Matematica_con_R_Volumen_I.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [Scala con Ejemplos](https://github.com/ErunamoJAZZ/ScalaByExample-es#traducción-del-libro-scala-by-example-al-español){:target="_blank" rel="nofollow"} (Github) (:construction: *en proceso*)
...
* [Aprendiendo Swift](https://applecoding.com/pdf/Aprendiendo-Swift-Extracto.pdf){:target="_blank" rel="nofollow"} (PDF) (2015)

[🔝 Inicio](/biblioteca-de-programacion-y-tecnologia/#-meta-listas){: .btn .btn--inverse .btn--large}

## Tex & LaTeX

* [¿Alergia al LaTeX? (2000)](https://www.sindominio.net/ayuda/latex/sdlatex.pdf){:target="_blank" rel="nofollow"} (PDF)
* [¿Qué es TeX?](https://www.cervantex.es/queestex){:target="_blank" rel="nofollow"}
* [Creación de ficheros LaTeX con GNU Emacs (2004)](ftp://ftp.dante.de/tex-archive/info/spanish/guia-atx/guia-atx.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Guía rápida de LaTeX (2014)](https://nokyotsu.com/latex/guia.html){:target="_blank" rel="nofollow"}
* [Introducción a LaTeX (2004)](https://www.sindominio.net/~xabier/old/curso_latex){:target="_blank" rel="nofollow"} (HTML)
* [La introducción no-tan-corta a LaTeX 2ε](https://osl.ugr.es/CTAN/info/lshort/spanish/lshort-a4.pdf){:target="_blank" rel="nofollow"} (PDF)
* [LaTeX para las humanidades](https://rt0016xp.eresmas.net/lplh/latex-humanidades.pdf){:target="_blank" rel="nofollow"} (PDF)
* [LaTeX: Procesamiento de textos científicos en alta calidad (2011)](HTML)
* [TeXemplares: Boletín de CervanTEX](https://www.cervantex.es/files/cervantex/texemplares9.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Todo sobre LaTeX (2016)](https://minisconlatex.blogspot.com.es){:target="_blank" rel="nofollow"} (HTML)
* [Una descripción de LaTeX2(1998)](https://www.profesores.frc.utn.edu.ar/electronica/teoriadeloscircuitosi/material/ldesc2e.pdf){:target="_blank" rel="nofollow"} (PDF)

## 🎮 Programación Videojuegos

* [Desarrollo de juegos en 2D usando Java y Microsoft XNA](https://openlibra.com/es/book/download/desarrollo-de-juegos-en-2d-usando-java-y-microsoft-xna){:target="_blank" rel="nofollow"} (PDF  )
* [Godot. Motor de Videojuegos - Documentación](https://media.readthedocs.org/pdf/godot-doc-en-espanol/latest/godot-doc-en-espanol.pdf){:target="_blank" rel="nofollow"} (PDF)
* [Programación de videojuegos SDL](https://libros.metabiblioteca.org/bitstream/001/271/8/Programacion_Videojuegos_SDL.pdf){:target="_blank" rel="nofollow"} (PDF)
...
* [Accesibilidad web en el SID](https://sid.usal.es/idocs/F8/FDO20873/InformeAccesibilidad.pdf){:target="_blank" rel="nofollow"} (2008)
* [Guía de Accesibilidad de Aplicaciones Móviles](https://drive.google.com/file/d/10MHIwij-bfliVYQnFX5FTXeyg5dqNS5N/view?usp=sharing){:target="_blank" rel="nofollow"} (2017) [Código Android](https://github.com/ctt-gob-es/Ejemplo-App-Accesible-Android#ejemplo-de-correcci%C3%B3n-de-errores-de-accesibilidad-en-una-app-para-android){:target="_blank" rel="nofollow"} [Código iOS](https://github.com/ctt-gob-es/Ejemplo-App-Accesible-iOS#todo-manager){:target="_blank" rel="nofollow"}
* [Guía de Accesibilidad en Documentos PDF con Adobe Acrobat 9.0](https://drive.google.com/file/d/1FhPza_vy39oGO6f61NRjK53kV3MtCEvt/view?usp=sharing){:target="_blank" rel="nofollow"} (2014)
* [Guía de Accesibilidad en Sedes Electrónicas](https://drive.google.com/file/d/1luB8F9ctvqfB3fUuQXGnLh3FRo7qEWAK/view?usp=sharing){:target="_blank" rel="nofollow"} (2019, Observatorio de Accesibilidad)
* [Guía de Accesibilidad para Editores Finales de Contenidos](https://drive.google.com/file/d/1MdXO6jpT70WiJgM6iuo0vd-QgPRV2pHH/view?usp=sharing){:target="_blank" rel="nofollow"} (2019)
* [Guía de Accesibilidad para la Gestión de la Accesibilidad en Gestores de Contenidos](https://drive.google.com/file/d/1gSuZe0koJmiNb1Oixcr-ckuJLE0T6A1a/view?usp=sharing){:target="_blank" rel="nofollow"} (2019, Observatorio de Accesibilidad)
* [Guía de Adaptación a WCAG 2.1 desde WCAG 2.0](https://drive.google.com/file/d/1GFjEX_k_FvIqP7QK3ka6uxWucNThP7rL/view?usp=sharing){:target="_blank" rel="nofollow"} (2018, Observatorio de Accesibilidad)
* [Guía de Validación de Accesibilidad Web](https://drive.google.com/file/d/1oxeZ92hEynCBxcrLmQcMukbLEkBlB5-u/view?usp=sharing){:target="_blank" rel="nofollow"} (2014, Observatorio de Accesibilidad)
* [Guía para la inserción de subtítulos en YouTube](https://drive.google.com/file/d/1Ajxnrof6Z5MmnmSbJiC5mnLRDxcB6Iw9/view?usp=sharing){:target="_blank" rel="nofollow"} (2018)
* [Guía de Recomendaciones de Accesibilidad y Calidad Web](https://drive.google.com/file/d/1QHD90j9eIzK8jvlXJz0lEearEK0wrngP/view?usp=sharing){:target="_blank" rel="nofollow"} (2009, Inteco)
* [Guía de Referencia: Accesibilidad de páginas web](https://drive.google.com/file/d/1sasun1WchSEIxDd7qe_JBILldnMNqgz3/view?usp=sharing){:target="_blank" rel="nofollow"} (2013, Once)
* [Informe de Accesibilidad Web Defensa.Gob.Es](https://www.defensa.gob.es/rapfas/Galerias/ficheros/Informe_de_accesibilidad_enero_2018.pdf){:target="_blank" rel="nofollow"} (2018)
* [Metodología del Observatorio de Accesbilidad Web UNE](https://www.defensa.gob.es/rapfas/Galerias/ficheros/Metodologia_Observatorio_Accesibilidad_Web-UNE2012-v1_0.pdf){:target="_blank" rel="nofollow"} (2012)
* [Proceso de validación nivel de accesibilidad web en sitios del Gobierno en línea del estado Colombiano](https://www.revistaespacios.com/a18v39n48/a18v39n48p08.pdf){:target="_blank" rel="nofollow"}
...
* [50 Estrategias para aumentar tu Tráfico Web](https://netgrows.com/wp-content/uploads/2019/02/eBook-netgrows-50-estrategias-para-aumentar-tu-trafico-web.pdf){:target="_blank" rel="nofollow"}
* [Posicionamiento en Buscadores](https://drive.google.com/file/d/12EkdvIOmV51r6gQxlakBrbe5RjQ_TDJR/view?usp=sharing){:target="_blank" rel="nofollow"}
* [SEO en Amazon](https://netgrows.com/wp-content/uploads/2018/11/ebook-amazon-netgrows.pdf){:target="_blank" rel="nofollow"}
...
Este repositorio esta bajo autoría de [Pablo Álvarez Corredera](https://ciberninjas.com/quien-soy){:target="_blank" rel="nofollow"}, los contribuidores de [Free Programming Books en Español](https://github.com/EbookFoundation/free-programming-books/blob/master/free-programming-books-es.md){:target="_blank" rel="nofollow"} especialmente, sobre una [Licencia Creative Commons 4.0](https://creativecommons.org/licenses/by/4.0/deed.es_ES){:target="_blank" rel="nofollow"}.

[🔝 Inicio](/biblioteca-de-programacion-y-tecnologia/#-meta-listas){: .btn .btn--inverse .btn--large}

### **Nos Referencian**

* [Consejo Escolar](https://www.consejoescolar.es/blog/libros-gratis-de-programacion){:target="_blank" rel="nofollow"}
* [Libraries IO](https://www.consejoescolar.es/blog/libros-gratis-de-programacion){:target="_blank" rel="nofollow"}
