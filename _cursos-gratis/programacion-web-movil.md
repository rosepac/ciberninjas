...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Cursos Programación Web y Móvil</li>
  </ol>
</nav>
</div>
...
<script type="application/ld+json">
{
 ...
 [
  ...
  "item":
   {
     "@id": "https://ciberninjas.com/cursos-programacion-web-movil/",
     "name": "Los Mejores Cursos Gratis de Programación Web y Móvil 2021"
   }
  }
 ]
}
