...
title: "▷ 21 Mejores Cursos Gratis de CMS / Sistemas de Gestión de Contenidos 2021"
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Cursos CMS</li>
  </ol>
</nav>
</div>
...
<script type="application/ld+json">
{
 ...
 [
  ...
  "item":
   {
     "@id": "https://ciberninjas.com/cursos-sistemas-gestion-cms/",
     "name": "Los Mejores Cursos Gratis de CMS / Sistemas de Gestión de Contenidos 2021"
   }
  }
 ]
}
...
- [Curso CMS Wordpress](https://www.youtube.com/playlist?list=PLbP-b3gf8hAWfajQG1e8r9bXNpRJHoBDb){:target="_blank" rel="nofollow,noreferrer"} (César Cancino, Youtube)
...
- [Taller Práctico de Creación de Plugins para Wordpress](https://www.youtube.com/playlist?list=PLbP-b3gf8hAVG0qm0uGO-muuIMxoX2ota){:target="_blank" rel="nofollow,noreferrer"} (César Cancino, Youtube)
