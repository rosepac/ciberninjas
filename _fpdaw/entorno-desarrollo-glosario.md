...
**base de datos**. *f* Conjunto estructurado de datos. El software especializado que gestiona estos datos se denomina sistema gestor de bases de datos (en inglés, DBMS).
