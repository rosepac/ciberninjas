---
# Página Base
title: "📚 ▷ Más de 400 Libros PDF de Programación, Desarrollo, Seguridad, Robótica, Blockchain.."
...
* [Gitbook - Libros útiles en español](https://kutt.it/gitbook-libros-espanol){:target="_blank"} (Github)
* [Múltiples Cursos y Enlaces de Tecnología Informática](https://kutt.it/web-fernando-berzal){:target="_blank"} - Fernando Berzal
* [OpenLibra - Biblioteca recopilatorio de libros libres](https://kutt.it/open-libra-espanol){:target="_blank"}
* [Revistas Científicas de Iberoamérica](https://www.latindex.unam.mx/latindex/inicio){:target="_blank"} [9700 Revistas](https://www.latindex.unam.mx/latindex/bAvanzada){:target="_blank"}
* [TLDP: servicios editoriales para la documentación libre en español (2007)](http://es.tldp.org/index.html){:target="_blank"} (CICA)
...
* [Base de Datos (2011)](https://openlibra.com/es/book/download/bases-de-datos-2){:target="_blank"} - Mercedes Marqués (PDF)
* [Base de Datos Avanzadas (2013)](https://openlibra.com/es/book/download/bases-de-datos-avanzadas){:target="_blank"} - Aramburu & Sanz Blasco (PDF)
...
* [Diseño e implementación de una base de datos relacional para la gestión de la red de bibliotecas.](http://openaccess.uoc.edu/webapps/o2/bitstream/10609/13921/1/jordibs_TFC_0610.pdf){:target="_blank"} (PDF)
* [El lenguaje SQL](https://www.pdf-manual.es/bases-de-datos/18-lenguaje-sql.html){:target="_blank"} (HTML)
* [El modelo relacional y el álgebra relacional](http://openaccess.uoc.edu/webapps/o2/bitstream/10609/200/8/Bases%20de%20datos_M%C3%B3dulo2_El%20modelo%20relacional%20y%20el%20%C3%A1lgebra%20relacional.pdf){:target="_blank"} (PDF)
...
* [Breves Notas sobre Autómatas y Lenguajes](http://lya.fciencias.unam.mx/jloa/publicaciones/automatasyLenguajes.pdf){:target="_blank"} (PDF)
* [Breves Notas sobre Teoría de la Computación](http://lya.fciencias.unam.mx/jloa/publicaciones/teoria.pdf){:target="_blank"} (PDF)
...
* [Metodología de modelado de sistemas de tiempo real orientada a la componibilidad](https://www.ctr.unican.es/publications/jlm-plm-jmd-2005a.pdf){:target="_blank"} (PDF)
...
* [Una aproximación dirigida por modelos para diseñar y construir esquemas XML: Un caso de estudio.](http://www.redalyc.org/pdf/1331/133115019007.pdf){:target="_blank"} (PDF)
...
* [Aspectos legales de explotación del software libre. Parte II](http://softlibre.unizar.es/manuales/legal/909.pdf){:target="_blank"} (PDF)
* [Compilación de ensayos sobre software libre (2002)](https://buleria.unileon.es/bitstream/handle/10612/1986/Gregorio.pdf){:target="_blank"} (PDF)
* [Copia este libro](http://www.rebelion.org/docs/23824.pdf){:target="_blank"} (PDF)
* [Copyleft: la creación se promueve... compartiéndola](http://www.sindominio.net/~xabier/old/textos/copyleft/copyleft.pdf){:target="_blank"} (PDF)
* [Guía básica del software de fuentes abiertas](http://softlibre.unizar.es/manuales/softwarelibre/guia_basica_sfa.pdf){:target="_blank"} (PDF)
* [Guía práctica sobre software libre. Su selección y aplicación local en América Latina y el Caribe](http://softlibre.unizar.es/manuales/softwarelibre/GSL_UNESCO.pdf){:target="_blank"} (PDF)
* [Internet, hackers y software libre](https://fortinux.com/wp-content/uploads/2010/12/editora_fantasma.pdf){:target="_blank"} (PDF)
* [Introducción al Software Libre](https://fortinux.com/wp-content/uploads/2010/12/softlibre.pdf){:target="_blank"} (PDF)
* [La catedral y el bazar](http://softlibre.unizar.es/manuales/softwarelibre/catedralbazar.pdf){:target="_blank"} (PDF)
* [La comunidad de Software Libre después de 20 años: Con un gran éxito incompleto, ¿y ahora qué?](https://smaldone.com.ar/documentos/docs/software_libre_20.pdf){:target="_blank"} (PDF)
* [La conquista silenciosa del ciberespacio](https://fortinux.com/wp-content/uploads/2010/12/La_Conquista_Silenciosa_del_Ciberespacio.pdf){:target="_blank"} (PDF)
* [La crisis del modelo de derecho de autor y las prácticas para democratizar la cultura](https://vialibre.org.ar/arcopy.pdf){:target="_blank"} (PDF)
* [La definición de Software Libre](http://softlibre.unizar.es/manuales/softwarelibre/free-sw.es.pdf){:target="_blank"} (PDF)
* [Libro blanco del Software Libre en España III](http://softlibre.unizar.es/manuales/softwarelibre/III_libro_blanco_del_software_libre.pdf){:target="_blank"} (PDF)
* [Metabolismo, comunicación y evolución en redes bacterianas y tecnológicas](http://www.sindominio.net/~xabier/old/textos/autobact/autobact.pdf){:target="_blank"} (PDF)
* [Migración al software libre. Guía de buenas prácticas](https://fortinux.com/wp-content/uploads/2010/12/migracionalsoftwarelibre.pdf){:target="_blank"} (PDF)
* [Posix de tiempo real (1993)](https://www.ctr.unican.es/publications/mgh-1993b.pdf){:target="_blank"} (PDF)
* [Sistema Operativo GNU/Linux Básico](http://softlibre.unizar.es/manuales/linux/868.pdf){:target="_blank"} (PDF)
* [Software libre para una sociedad libre](https://www.gnu.org/philosophy/fsfs/free_software.es.pdf){:target="_blank"} (PDF) (Richard M. Stallman)
* [Software libre: técnicamente viable, económicamente sostenible y socialmente justo](http://www.infonomia.com/img/pdf/llibrejmas.pdf){:target="_blank"} (PDF)
* [Software libre vs software propietario. Ventajas y desventajas](http://www.rebelion.org/docs/32693.pdf){:target="_blank"} (PDF)
* [Tensión en la Red (2014)](https://www.estebanmagnani.com.ar/wp-content/uploads/2014/09/Tension-en-la-red-interior.pdf){:target="_blank"} (PDF)
...
* [Diseño Ágil con TDD](http://www.carlosble.com/downloads/disenoAgilConTdd_ebook.pdf){:target="_blank"} (PDF)
* [El Control de Versiones en el aprendizaje de la Ingeniería Informática: Un enfoque práctico](http://bioinfo.uib.es/~joemiro/aenui/procJenui/Jen2007/ruelco.pdf){:target="_blank"} (PDF)
...
* [Ingeniería de Software: Una Guía para Crear Sistemas de Información](https://web.archive.org/web/20150824055042/http://www.wolnm.org/apa/articulos/Ingenieria_Software.pdf){:target="_blank"} (PDF)
* [Más allá de Google (2008)](http://www.infonomia.com/wp-content/uploads/2014/11/40.-Mas-alla-de-Google.pdf){:target="_blank"} (PDF)
* [Scrum & Extreme Programming (para programadores)](https://web.archive.org/web/20140209204645/http://www.cursosdeprogramacionadistancia.com/static/pdf/material-sin-personalizar-agile.pdf){:target="_blank"} (PDF)
* [Scrum y XP desde las trincheras](http://www.proyectalis.com/wp-content/uploads/2008/02/scrum-y-xp-desde-las-trincheras.pdf){:target="_blank"} (PDF)
* [Sistemas para el Control de Versiones](http://rodin.uca.es/xmlui/bitstream/handle/10498/9785/trabajoSCV.pdf){:target="_blank"} (PDF)
...
* [Armado y reparación de PC](http://nksistemas.com/curso-de-armado-y-reparacion-de-pc){:target="_blank"} (HTML)

## 👨‍💻 Paradigmas de Programación

* [97 cosas que todo programador debería saber](http://97cosas.com/programador){:target="_blank"} (HTML)
* [El Manifiesto Mónada (Anotado)](https://leanpub.com/monad-manifesto-annotated-spanish?){:target="_blank"} (PDF)
* [Programación Funcional (1996)](http://www.staff.science.uu.nl/~fokke101/courses/fp-sp.pdf){:target="_blank"} (PDF)

## 👦 Programación Niñ@s / Inicial

### App Inventor

* [Desarrollo de aplicaciones para Android usando MIT App Inventor 2 -2016](https://openlibra.com/en/book/download/desarrollo-de-aplicaciones-para-android-usando-mit-app-inventor-2){:target="_blank"} [2013](https://tecnoarboleda.files.wordpress.com/2014/02/desarrollo-para-android-usando-mit-appinventor.pdf){:target="_blank"}

### Scratch <i class="fas fa-paw"></i>

* [Animar un Nombre](https://resources.scratch.mit.edu/www/cards/es/name-cards.pdf){:target="_blank"} [Guía Profesor, en Inglés](https://resources.scratch.mit.edu/www/guides/en/NameGuide.pdf){:target="_blank"} [Practicar](https://scratch.mit.edu/projects/editor/?tutorial=name){:target="_blank"}
* [Animar un Personaje](https://resources.scratch.mit.edu/www/cards/es/animation-cards.pdf){:target="_blank"} [Guía Profesor, en Inglés](https://resources.scratch.mit.edu/www/guides/en/AnimateGuide.pdf){:target="_blank"} [Practicar](https://scratch.mit.edu/projects/editor/?tutorial=animate-a-character){:target="_blank"}
* [Cartas de Aprendizaje de Pasos Sencillos en Scratch](https://resources.scratch.mit.edu/www/cards/es/scratch-cards-all.pdf){:target="_blank"} (PDF)
* [Crear Historia](https://resources.scratch.mit.edu/www/cards/es/story-cards.pdf){:target="_blank"} [Guía Profesor, en Inglés](https://resources.scratch.mit.edu/www/guides/en/StoryGuide.pdf){:target="_blank"} [Practicar](https://scratch.mit.edu/projects/editor/?tutorial=tell-a-story){:target="_blank"}
* [Crear Juego de Persecución](https://resources.scratch.mit.edu/www/cards/es/chase-cards.pdf){:target="_blank"} [Guía Profesor, en Inglés](https://resources.scratch.mit.edu/www/guides/en/ChaseGuide.pdf){:target="_blank"} [Practicar](https://scratch.mit.edu/projects/editor/?tutorial=chase-game){:target="_blank"}
* [Crear Música](https://resources.scratch.mit.edu/www/cards/es/music-cards.pdf){:target="_blank"} [Guía Profesor, en Inglés](https://resources.scratch.mit.edu/www/guides/en/MusicGuide.pdf){:target="_blank"} [Practicar](https://scratch.mit.edu/projects/editor/?tutorial=music){:target="_blank"}
* [Guía de Referencia de Scratch 2.0](http://lsi.vc.ehu.es/pablogn/docencia/FdI/Scratch/ScratchGuiaReferencia.pdf){:target="_blank"} (PDF)
* [Manual de Scratch](http://lsi.vc.ehu.es/pablogn/docencia/FdI/Scratch/manual%20scratch.pdf){:target="_blank"} (PDF)
* [Manual de Scratch 2](http://lsi.vc.ehu.es/pablogn/docencia/FdI/Scratch/Aprenda%20a%20programar%20con%20Scratch%20en%20un%20par%20de%20tardes.pdf){:target="_blank"}  (PDF)
...
* [Activismo digital y telemático. Poder y contrapoder en el ciberespacio (2003)](http://www.seaceptanideas.com/wp-content/uploads/2016/07/Activismo_digital_y_telemC3A1tico.pdf){:target="_blank"} (PDF)
...
* [Ciber-Resiliencia: Aproximación a un marco de medición](https://www.certsi.es/sites/default/files/contenidos/estudios/doc/int_ciber_resiliencia_marco_medicion.pdf){:target="_blank"} (PDF)
* [Ciberseguridad en las Comunicaciones Inalámbricas en Entornos Industriales](https://www.certsi.es/sites/default/files/contenidos/guias/doc/certsi_ciberseguridad_comunicaciones_inalambricas_entornos_industriales.pdf){:target="_blank"} (PDF)
* [Creando Reportes HTML en Powershell](https://leanpub.com/why-powershell-spanish?){:target="_blank"} (PDF)
* [Detección de ATPs](https://www.certsi.es/sites/default/files/contenidos/estudios/doc/deteccion_apt.pdf){:target="_blank"} (PDF)
* [Determinación de aspectos clave de la seguridad de la información, procesos informáticos y recursos tecnológicos](http://revistaespacios.com/a19v40n30/a19v40n30p22.pdf){:target="_blank"}
* [Diseño y configuración de IPS, IDS y SIEM en Sistemas de Control Industrial](https://www.certsi.es/sites/default/files/contenidos/guias/doc/certsi_diseno_configuracion_ips_ids_siem_en_sci.pdf){:target="_blank"} (PDF)
* [Estudio de viabilidad, oportunidad y diseño de una red de centros de excelencia en I+D+I en ciberseguridad](https://www.certsi.es/sites/default/files/contenidos/estudios/doc/informe_resumen_estudio_red_centros_excelencia.pdf){:target="_blank"} (PDF)
* [Guía básica de protección de Infraestructuras Críticas: el puesto de operador](https://www.certsi.es/sites/default/files/contenidos/guias/doc/int_cnpic_proteccion_puesto_operador.pdf){:target="_blank"} (PDF)
* [Guía básica de seguridad en Magento](https://www.certsi.es/sites/default/files/contenidos/guias/doc/cert_guia_seguridad_magento.pdf){:target="_blank"} (PDF)
* [Guía básica para la securización del gestor de contenidos Joomla!](https://www.certsi.es/sites/default/files/contenidos/guias/doc/guia__securizando_joomla.pdf){:target="_blank"} (PDF)
* [Guía de Seguridad en Protocolos Industriales – Smart Grid](https://www.certsi.es/sites/default/files/contenidos/guias/doc/certsi_seguridad_protocolos_industriales_smartgrid.pdf){:target="_blank"} (PDF)
* [Guia de Seguridad en servicios DNS](https://www.certsi.es/sites/default/files/contenidos/guias/doc/guia_de_seguridad_en_servicios_dns.pdf){:target="_blank"} (PDF)
* [Guía de toma de evidencias en entornos Windows](https://www.certsi.es/guias-y-estudios/guias/toma-evidencias-windows){:target="_blank"} (PDF)
* [Hacking: fuzzing, análisis y exploit](https://lsi.vc.ehu.eus/wdocs/pdd/pdd-2017/pdf/02.pdf){:target="_blank"} (PDF)
* [Hacklabs ensamblaje colectivo de la tecnopolítica como
realidad social](http://www.sindominio.net/~xabier/old/textos/hl/hl.pdf){:target="_blank"} (PDF)
* [Identificación y reporte de incidentes de seguridad para operadores estratégicos: Guía básica de protección de Infraestructuras Críticas](https://www.certsi.es/guias-y-estudios/guias/inteco-publica-guia-reporte-incidentes-iicc){:target="_blank"} (PDF)
...
* [Android Lollipop 5.0. Guía de inicio rápido](https://www.compromovil.es/manuales/Manual_de_Instrucciones_en_Espa%C3%B1ol_Android_5_0_Lollypop.pdf){:target="_blank"} (PDF)
* [Aprendemos a manejar el computador (2009)](http://www.iered.org/archivos/Publicaciones_Libres/2009_Aprendamos_Manejo_Computador/Manejo-Computador_Texto_v4.pdf){:target="_blank"} (PDF)
* [De tractores y routers. Tecnosoberanía, Seguridad, Obsolescencia Programada y Software Libre](https://lsi.vc.ehu.eus/wdocs/pdd/pdd-2017/pdf/03.pdf){:target="_blank"} (PDF)
* [Fundamentos de Sistemas Operativos](http://sistop.org/pdf/sistemas_operativos.pdf){:target="_blank"} - Gunnar Wolf et al (PDF)
* [Iniciación al software libre: OpenOffice](http://softlibre.unizar.es/manuales/softwarelibre/Manual_zaragoza_alta.pdf){:target="_blank"} (PDF)
* [Mantenimiento de computadoras (2011)](http://www.iered.org/archivos/Publicaciones_Libres/2011_Mantenimiento_Computadores/MantenimientoDeComputadores.pdf){:target="_blank"} (PDF)
* [Sistemas Operativos](http://exa.unne.edu.ar/depar/areas/informatica/SistemasOperativos/sistope2.PDF){:target="_blank"} - Dr. David Luis la Red (PDF)
* [Sistemas operativos en las netbooks: GNU/Linux y Microsoft Windows.](http://bibliotecadigital.educ.ar/uploads/contents/M-SistemasoperataivosVF10.pdf){:target="_blank"} (PDF)

### iPhone

* [Cómo Copiar el Código Fuente de Ejemplo del iBook a Xcode](https://applecoding.com/pdf/copiar-codigo-fuente-ibook.pdf){:target="_blank"} (PDF)

## Software

## Consola y Editores de Texto

* [¿Por qué Powershell?](https://leanpub.com/big-book-of-powershell-error-handling-spanish?){:target="_blank"}
* [El Gran Libro de Manejo de Errores en Powershell](https://leanpub.com/big-book-of-powershell-error-handling-spanish?){:target="_blank"}
* [El Gran Libro de Trucos de Powershell](https://leanpub.com/big-book-of-powershell-gotchas-spanish?){:target="_blank"}
* [Secretos de Powershell Remoting](https://leanpub.com/secrets-of-powershell-remoting-spanish?){:target="_blank"}

## Anotaciones y Transcripciones
* [Introducción a ELAN](http://idiom.ucsd.edu/~jfernand/Papers/ELAN.pdf){:target="_blank"} (PDF)
* [Manual de Procesamiento de Archivos ELAN](http://pyersqr.org/minimal/Manual_Procesamiento%20de%20archivos%20ELAN.pdf){:target="_blank"}
...
* [Ciencias de la Información (8 revistas)](http://www.redalyc.org/area.oa?id=23&tipo=coleccion&bJats=1){:target="_blank"}
* [Computación y Sistemas](http://www.redalyc.org/revista.oa?id=615){:target="_blank"} (HTML)
* [Espacios](http://www.revistaespacios.com/indice.html){:target="_blank"} (PDF) (HTML)
* [Estudios Urbanos y Ciencias Sociales](http://www2.ual.es/urbs/index.php/urbs/issue/archive){:target="_blank"} (PDF)
* [Gerencia Tecnológica Informática (2015)](https://dialnet.unirioja.es/servlet/revista?codigo=11969){:target="_blank"}
* [Iberoaméricana de las Ciencias Computacionales e Informática](http://www.reci.org.mx/index.php/reci/issue/archive){:target="_blank"} (HTML)
...
## Arduino 🔦
* [Arduino. Guía Completa](http://arduinobot.pbworks.com/w/page/10175775/FrontPage){:target="_blank"} (HTML)
...
* [Arduino. Manual de Programación](http://arduinobot.pbworks.com/f/Manual%2BProgramacion%2BArduino.pdf){:target="_blank"} (PDF)
...
* [Introducción a la arquitectura de computadores con QtARMSim y Arduino](http://lorca.act.uji.es/libro/introARM/introARM_ebook_2017.pdf){:target="_blank"} (PDF)
* [Propuesta para grupo de investigación Autonomía Situada (2003)](http://www.sindominio.net/~xabier/old/textos/propuesta/propuesta.html){:target="_blank"} (HTML)
* [Topos: Reconocimiento de patrones temporales en sonidos reales con redes neuronales de pulsos](http://lsi.vc.ehu.es/pablogn/investig/ficheros/albaTopos.pdf){:target="_blank"} (PDF)
* [Utilizando Arduino Due en la docencia de la entrada/salida](http://bioinfo.uib.es/~joemiro/aenui/procJenui/Jen2015/ba_util.pdf){:target="_blank"} (PDF)

## 👩‍💻 Desarrollo Web

## Android <i class="fab fa-android"></i>

* [Android 100%](https://drive.google.com/file/d/0BwVU1KZh_7htTmxPdmRmTVpaYjg/view){:target="_blank"} (PDF)
* [Curso Android](http://www.hermosaprogramacion.com/android){:target="_blank"} (HTML)
* [Desarrollo de una aplicación móvil Android para control remoto de un servicio web (2012)](https://e-archivo.uc3m.es/bitstream/handle/10016/16913/TFG_Maria_Lozano_Perez.pdf){:target="_blank"} (PDF)
* [EasyManet for Android (2013)](https://riunet.upv.es/bitstream/handle/10251/32786/Memoria.pdf){:target="_blank"} (PDF)
* [Guía para la realización de aplicaciones móviles en los sistemas operativos Android e iOS](http://repository.udistrital.edu.co/bitstream/11349/6274/1/AvilaCruzHelmanCamilo2017.pdf){:target="_blank"} (PDF)
* [Introducción a Android](http://www.it-docs.net/ddata/18.pdf){:target="_blank"} (PDF)
...
* [Manual de Programación Android v.2.0](http://ns2.elhacker.net/timofonica/manuales/Manual_Programacion_Android_v2.0.pdf){:target="_blank"} - Salvador Gómez Oliver (PDF)
...
* [GNU/Linux: Programación de Sistemas](http://www.alcancelibre.org/filemgmt_data/files/programaciongnulinux.pdf){:target="_blank"} (PDF)
* [Introducción a la programación con C](http://repositori.uji.es/xmlui/bitstream/handle/10234/24306/s29.pdf){:target="_blank"} (PDF)(descarga directa)

## C++

* [Aprenda C++ avanzado como si estuviera en primero](http://www4.tecnun.es/asignaturas/Informat1/AyudaInf/aprendainf/cpp/avanzado/cppavan.pdf){:target="_blank"} (PDF)
* [Aprenda C++ básico como si estuviera en primero](http://www4.tecnun.es/asignaturas/Informat1/AyudaInf/aprendainf/cpp/basico/cppbasico.pdf){:target="_blank"} (PDF)
* [Ejercicios de programación creativos y recreativos en C++](http://antares.sip.ucm.es/cpareja/libroCPP/){:target="_blank"} (HTML)
* [Fundamentos de Programación con el Lenguaje de Programación C++ (2017)](http://www.lcc.uma.es/~vicente/docencia/cppdoc/programacion_cxx.pdf){:target="_blank"} (PDF)
...
* [Una Introducción a Emacs Lisp en Español](http://savannah.nongnu.org/git/?group=elisp-es){:target="_blank"} (HTML)
...
* [Git Immersion en Español](https://esparta.github.io/gitimmersion-spanish){:target="_blank"}
* [Git Magic (2007)](https://openlibra.com/es/book/download/git-magic){:target="_blank"}
* [Git. Fundamentos](https://www.jesusamieiro.com/wp-content/uploads/2015/10/Guion_comandos.pdf){:target="_blank"} (PDF)
* [Git. La guía simple](http://rogerdudler.github.io/git-guide){:target="_blank"} (HTML)
* [Gitmagic](http://www-cs-students.stanford.edu/~blynn/gitmagic/intl/es){:target="_blank"}
* [Pro Git](http://git-scm.com/book/es/){:target="_blank"}
...
* [Go: Un pequeño libro](http://raulexposito.com/documentos/go/go.pdf){:target="_blank"} (PDF)

## Haskell

* [¡Aprende Haskell por el bien de todos!](http://aprendehaskell.es/main.html){:target="_blank"} (HTML)
...
* [CSS avanzado](http://librosweb.es/libro/css_avanzado){:target="_blank"} Javier Eguíluz (HTML) [(PDF)](https://openlibra.com/es/book/download/css-avanzado){:target="_blank"}
* [CSS3 y JavaScript avanzado](https://openlibra.com/es/book/download/css3-y-javascript-avanzado){:target="_blank"} (PDF)
* [Diseño de Interfaces Web](http://interfacesweb.github.io/unidades/){:target="_blank"} (HTML)
* [Estructura con CSS](http://es.learnlayout.com){:target="_blank"} (HTML)
* [Guía Completa de CSS3](https://openlibra.com/es/book/download/guia-completa-de-css3){:target="_blank"} - Antonio Navajas (PDF)
* [HTML5](http://www.arkaitzgarro.com/html5){:target="_blank"} - Arkaitz Garro (HTML) [(PDF)](https://openlibra.com/es/book/download/html5){:target="_blank"}
* [Introducción a CSS](http://librosweb.es/libro/css/){:target="_blank"} - Javier Eguíluz (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-css){:target="_blank"}
* [Introducción a XHTML](http://librosweb.es/libro/xhtml){:target="_blank"} (HTML)
* [Sass, el manual oficial](http://librosweb.es/libro/sass/){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-xhtml){:target="_blank"}

## Java <i class="fab fa-java"></i>

* [Aprenda Java como si estuviera en primero](https://fiwiki.org/images/9/9c/Aprenda_Java_como_si_estuviera_en_primero.pdf){:target="_blank"} (PDF)
* [Aprendiendo Java y POO (2008)](http://www.decom-uv.cl/~roberto/apuntes/java/AprendiendoJava.pdf){:target="_blank"} (PDF)
* [Desarrollo de proyectos informáticos con Java](http://www3.uji.es/~belfern/libroJava.pdf){:target="_blank"} (PDF)
* [Ejercicios de Programación en Java](https://www.arkaitzgarro.com/java){:target="_blank"} - F.M. Pérez Montes (PDF)
* [Java](https://www.arkaitzgarro.com/java){:target="_blank"} (HTML)
* [Notas de Introducción al Lenguaje de Programación Java (2004)](http://lya.fciencias.unam.mx/jloa/publicaciones/introduccionJava.pdf){:target="_blank"} - Jorge L. Ortega Arjona (PDF)
* [Pensando la computación como un científico (con Java)](http://www.ungs.edu.ar/cm/uploaded_files/publicaciones/476_cid03-Pensar%20la%20computacion.pdf){:target="_blank"} (PDF)
* [PlugIn Apache Tapestry: desarrollo de aplicaciones y páginas web](https://picodotdev.github.io/blog-bitix/assets/custom/PlugInTapestry.pdf){:target="_blank"} (PDF) [(ePub, Mobi, HTML)](https://picodotdev.github.io/blog-bitix/2014/02/libro-sobre-desarrollo-de-aplicaciones-con-apache-tapestry/){:target="_blank"}
* [Prácticas d Java (2009)](https://openlibra.com/es/book/download/practicas-de-java){:target="_blank"} (PDF)
* [Preparando JavaSun 6 - OCPJP6](https://github.com/PabloReyes/ocpjp-resumen-espanol#ocpjp6-resumen-español){:target="_blank"} - Pablo Reyes Almagro (Github) [(PDF)](https://github.com/PabloReyes/ocpjp-resumen-espanol/blob/master/OCPJP6%20Resumen.pdf){:target="_blank"}
* [Programación en Java](http://elvex.ugr.es/decsai/java){:target="_blank"} (HTML)
* [Tutorial básico de Java EE](http://static1.1.sqspcdn.com/static/f/923743/14770633/1416082087870/JavaEE.pdf){:target="_blank"} (PDF)
* [Tutorial introducción a Maven 3](http://static1.1.sqspcdn.com/static/f/923743/15025126/1320942755733/Tutorial_de_Maven_3_Erick_Camacho.pdf){:target="_blank"} - Erick Camacho (PDF)

## <i class="fab fa-js"></i> JavaScript

* [Guía de Javascript 'Mozilla'](https://developer.mozilla.org/es/docs/Web/JavaScript/Guide){:target="_blank"} (HTML)
* [Introducción a AJAX](http://librosweb.es/libro/ajax){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-ajax){:target="_blank"}
* [Introducción a JavaScript](http://librosweb.es/libro/javascript){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-javascript){:target="_blank"}
* [Jardín de JavaScript](http://bonsaiden.github.io/JavaScript-Garden/es){:target="_blank"} (HTML)
* [JavaScript, ¡Inspírate!](https://leanpub.com/javascript-inspirate){:target="_blank"} (Descarga PDF)
* [JavaScript Para Gatos](https://jsparagatos.com){:target="_blank"} (HTML)
* [Manual de JavaScript](https://desarrolloweb.com/manuales/manual-javascript.html#capitulos20){:target="_blank"} (HTML)

### Angular <i class="fab fa-angular"></i>

* [Cómo aprender AngularJS](http://raulexposito.com/documentos/como-aprender-angularjs){:target="_blank"} (HTML)

### D3.js

* [Tutorial de D3](http://gcoch.github.io/D3-tutorial/index.html){:target="_blank"} (HTML)

### jQuery

* [Fundamentos de jQuery](https://librosweb.es/libro/fundamentos_jquery){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/fundamentos-de-jquery){:target="_blank"}
* [Manual de jQuery](http://mundosica.github.io/tutorial_hispano_jQuery/){:target="_blank"} (HTML)

### Node <i class="fab fa-node-js"></i>

* [Introducción a Node.js a través de Koans](http://nodejskoans.com){:target="_blank"}
* [Tutorial para Principiantes en Node.js](http://www.nodebeginner.org/index-es.html){:target="_blank"}
...
* [El lenguaje de programación C#](http://dis.um.es/~bmoros/privado/bibliografia/LibroCsharp.pdf){:target="_blank"} (PDF)
...
* [Redis: Un pequeño libro](http://raulexposito.com/documentos/redis/redis.pdf){:target="_blank"} (PDF)
...
* [Programación web avanzada: ajax y google maps](http://rua.ua.es/dspace/bitstream/10045/13176/9/04-ajaxphp.pdf){:target="_blank"} (PDF)
* [Silex, el manual oficial](http://librosweb.es/libro/silex){:target="_blank"} (HTML) 
* [Symfony 1.4, la guía definitiva](http://librosweb.es/libro/symfony_1_4){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/symfony-la-guia-definitiva){:target="_blank"}
* [Symfony 2.4, el libro oficial](http://librosweb.es/libro/symfony_2_4/){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/manual-de-symfony2-ver-2-0-12){:target="_blank"}
...
* [Inmersión en Python](http://es.diveintopython.net/toc.html){:target="_blank"} (HTML)
...
* [Introducción a la programación con Python](http://repositori.uji.es/xmlui/bitstream/handle/10234/24305/s23.pdf){:target="_blank"} (PDF)
* [Introducción a Programando con Python](http://opentechschool.github.io/python-beginners/es_CL/){:target="_blank"} (HTML)
...
* [Python. No muerde, yo sí.](https://media.readthedocs.org/pdf/python-no-muerde/latest/python-no-muerde.pdf){:target="_blank"} (PDF) [(HTML)](http://python-no-muerde.readthedocs.io/es/latest){:target="_blank"}
* [Tryton: gestión de empresas](https://media.readthedocs.org/pdf/tryton-ar/latest/tryton-ar.pdf){:target="_blank"} (PDF) [(HTML)](http://tryton-ar.readthedocs.io/es/latest/introduccion.html){:target="_blank"}


### Django

* [Django. Documentación](https://media.readthedocs.org/pdf/djangotutorial/1.8/djangotutorial.pdf){:target="_blank"} (PDF)
...
* [Ruby en 20 minutos](https://www.ruby-lang.org/es/documentation/quickstart){:target="_blank"} (HTML)
* [Ruby tutorial o como pasar un buen rato programando](http://rubytutorial.wikidot.com/introduccion){:target="_blank"} (HTML)


### Ruby on Rails

* [Introducción a Rails](http://rubysur.org/introduccion.a.rails){:target="_blank"} (Gitbook)
* [Introducción a Ruby on Rails](http://librosweb.es/libro/introduccion_rails){:target="_blank"} (HTML)


## R

* [Cartas sobre Estadística de la Revista Argentina de Bioingeniería](http://cran.r-project.org/doc/contrib/Risk-Cartas-sobre-Estadistica.pdf){:target="_blank"} (PDF)
* [Generacion automática de reportes con R y LaTeX](http://cran.r-project.org/doc/contrib/Rivera-Tutorial_Sweave.pdf){:target="_blank"} (PDF)
* [Gráficos Estadísticos con R](http://cran.r-project.org/doc/contrib/grafi3.pdf){:target="_blank"} (PDF)
* [Introducción a R](http://cran.r-project.org/doc/contrib/R-intro-1.1.0-espanol.1.pdf){:target="_blank"} (PDF)
* [Introducción al uso y programación del sistema estadístico R](http://cran.r-project.org/doc/contrib/curso-R.Diaz-Uriarte.pdf){:target="_blank"} (PDF)
* [Métodos Estadísticos con R y R Commander](http://cran.r-project.org/doc/contrib/Saez-Castillo-RRCmdrv21.pdf){:target="_blank"} (PDF)
* [Optimización Matemática con R: Volúmen I](http://cran.r-project.org/doc/contrib/Optimizacion_Matematica_con_R_Volumen_I.pdf){:target="_blank"} (PDF)
* [Programación en R del método de las palabras asociadas](http://www.docentes.unal.edu.co/cepardot/docs/TrabajosGrado/TrabajoGrado_Daniel.pdf){:target="_blank"} (PDF)
* [R para Principiantes](http://cran.r-project.org/doc/contrib/rdebuts_es.pdf){:target="_blank"} (PDF)
