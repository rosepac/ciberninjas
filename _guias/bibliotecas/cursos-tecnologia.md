...
* [Expresiones Regulares (Regex)](https://www.udemy.com/course/expresiones-regulares-regex/) (Udemy) (2019)
* [Linux para principiantes](https://www.udemy.com/course/linux-para-principiantes-1/) (Udemy) (2019)
...
* [App Inventor: Como usar el componente Sound](https://www.udemy.com/como-usar-el-componente-sound-sin-morir-en-el-intento){:target="_blank"} (Udemy)
* [App Inventor: Componente Contact Picker](https://www.udemy.com/app-inventor-2-componente-contact-picker){:target="_blank"} (Udemy)
* [App Inventor: Dragged y Flung](https://www.udemy.com/app-inventor-a){:target="_blank"} (Udemy)
* [App Inventor: Videoplayer](https://www.udemy.com/app-inventor-2-videoplayer){:target="_blank"} (Udemy)
* [App Inventor: Componente Yandex. Translate](https://www.udemy.com/app-inventor-2-componente-yandextranslate){:target="_blank"} (Udemy)
* [App Inventor: Componente SoundRecorder](https://www.udemy.com/curso-del-componente-soundrecorder-de-app-inventor){:target="_blank"} (Udemy)
* [App Inventor: Componente HorizontalArrangement](https://www.udemy.com/app-inventor-y-su-componente-horizontalarrangement){:target="_blank"} (Udemy)
* [App Inventor: Componente Polygon](https://www.udemy.com/app-inventor-2-componente-polygon){:target="_blank"} (Udemy)
* [App Inventor: Descubre Rectangle](https://www.udemy.com/componente-rectangle-maps-app-inventor){:target="_blank"} (Udemy)
* [App Inventor: Ev3 Commands y App Inventor](https://www.udemy.com/ev3-commands){:target="_blank"} (Udemy)
* [App Inventor: ImagePicker](https://www.udemy.com/appinvento2-imagepicker){:target="_blank"} (Udemy)
* [App Inventor: ListView](https://www.udemy.com/app-inventor-listview){:target="_blank"} (Udemy)
* [App Inventor: NxtLightSensor](https://www.udemy.com/app-inventor-2-nxtlightsensor){:target="_blank"} (Udemy)
* [App Inventor: Slider e Introducción](https://www.udemy.com/slider-introduccion-a-appinventor){:target="_blank"} (Udemy)
...
* [Curso de C y C++ ¡Desde 0!](https://www.udemy.com/course/aprende-c-y-c-en-1-curso-master-en-programacion/) (Udemy) (2019)
...
* [Introducción a CodeIgniter](https://www.udemy.com/introduccion-codeigniter){:target="_blank"} (Udemy)
...
* [Programación para todos (empezando con Python)](https://www.edx.org/es/course/programacion-para-todos-empezando-con-python) (2019) (EDX \ Universidad de Michigan)
...
* [Taller de creación de Backdoors con Python - Parte 1](https://www.udemy.com/course/backdoors-with-python) (Udemy) (2019)
...
* [Crear una REST API desde Cero con NodeJS y AdonisJS](https://www.udemy.com/course/curso-crea-una-rest-api-desde-cero-con-nodejs-y-adonisjs/) (Udemy) (2019)
...
* [Editores de Código: Visual Studio Code y Sublime Text](https://www.udemy.com/course/visual-studio-code-y-sublime-text-se-rapido-para-codificar/) (Udemy) (2019)
