...
* Herramientas para escritores noveles [(artículo)](https://comunidad.iebschool.com/javierbelarra/2016/06/15/herramientas-de-escritores-noveles)
* Licencias Creative Commons [(documentación)](https://creativecommons.org/licenses/?lang=es_ES)
* Web Empresa [(blog)](https://www.webempresa.com/blog.html)
...
* [Bluehost](https://www.bluehost.com) empresa profesional de hosting económico con instalador sencillo y rápido.
* Buscar dominios -nombres de url- [(gratis)](http://freeavailabledomains.com/en/) **NO** recomendado.
* Configurar WordPress en un servidor remoto [(artículo)](http://www.gianoliveira.com/configurar-wordpress-en-servidor-remoto.html)
* [Descarga de XAMP + WordPress](https://bitnami.com/stack/xampp#wordpress)
* Dominios de pago baratitos: [1and1](https://www.1and1.es) o [GoDaddy](https://es.godaddy.com); existen más empresas.
* Hosting Gratis: [Viewen](https://viewen.com/free-cloud-hosting) solo te pide registro a través de tu Facebook personal y que mensualmente compartas el enlace de sus empresa en el -**caralibro-**. 100% funcional.
* Instalación paso a paso de WordPress + XAMP [(artículo)](https://steemit.com/steempress/@eddiespino/llevatuspublicacionesaotronivel-i8rpclyrth) by @eddiespino
* Instalación WordPress de forma local [(videotutorial youtube)](https://www.youtube.com/watch?v=0CGRBKxPnVQ)
* Instalar WampServer en Windows y configurar 2016 [(videotutorial youtube)](https://www.youtube.com/watch?v=nrcB0dLmg1w)
* Migrar WordPress de local a remoto [(artículo)](http://www.gianoliveira.com/wordpress-de-local-a-remoto.html)
* Modificar el DNS de un dominio [(documentación)](https://www.1and1.es/ayuda/dominios/configuracion-dns)
* [Poedit](https://poedit.net) software con el que generar el archivo de las traducciones de una plantilla.
* [Ranking](https://es.hostadvice.com/hosting-services/filters--server_location-europe) de diferentes Hosting Web´s.
...
* Cómo crear una plantilla WordPress desde cero [(artículo)](https://www.inboundcycle.com/blog-de-inbound-marketing/como-crear-una-plantilla-de-wordpress-desde-cero-parte-1)
* Crear un tema hija para Divi o cualquier plantilla de Wordpress [(artículo)](https://creativolandia.com/tema-hijo-para-divi-o-extra-elegant-themes)
* Curso: como crear un theme para wordpress desde 0 [(videotutorial Youtube)](https://www.youtube.com/watch?v=L0SrVrpegBw&list=PLhSj3UTs2_yUwYp_ueyulofOhRBKYa4j-)
* Documentación de Divi en español [(documentación)](https://www.tantomarketing.com/documentacion-de-divi-en-espanol/vistazo-al-constructor)
* Porqué Elementor ha pasado a ser mi maquetador visual gratuito favorito [(artículo)](https://raiolanetworks.es/blog/elementor-maquetador-visual-gratuito-wordpress/)
...
* 25 Plantillas gratis basadas en Bootstrap para WordPress [(artículo)](https://colorlib.com/wp/free-bootstrap-wordpress-themes)
* 30 plantillas gratuitas basadas en el framework Genesis [(artículo)](https://digital.com/blog/free-genesis-child-themes)
* 50 mejores plantillas de 2.018 [(artículo)](https://www.codeinwp.com/blog/best-free-wordpress-themes)
* Just Free Themes [(blog)](https://justfreethemes.com)
* Las 30 mejores plantillas de página única gratis para Wordpress [(artículo)](https://www.codeinwp.com/blog/free-one-page-wordpress-themes)
* Plantilla minimalista: [Editor Independiente](https://es.wordpress.org/themes/independent-publisher)
* Plantilla para fotógrafos: [Portfolio](https://modernthemes.net/wordpress-themes/portfolio/?ref=70)
* Plantillas sencillas con versiones gratis [(blog)](https://athemes.com/wordpress-themes/free)
...
* 5 plugins recomendados para realizar copias de seguridad en WordPress [(artículo)](https://www.webempresa.com/blog/5-plugins-recomendados-para-realizar-copias-de-seguridad-en-wordpress.html)
* 22 pasos para proteger wordpress: seguridad anti-hackers [(artículo)](http://aulacm.com/seguridad-y-proteger-wordpress)
* Activar SSL en WordPress [(artículo)](https://www.webempresa.com/blog/activar-ssl-https-en-wordpress.html)
* Certificado Let´s Encrypt [(artículo)](https://www.webempresa.com/hosting/certificado-ssl-gratis-lets-encrypt.html)
* Cloudflare [(artículo)](https://support.cloudflare.com/hc/es-es/articles/205177068-Paso-1-C%C3%B3mo-funciona-Cloudflare-), paso a paso. Servicio que ofrece varias opciones de seguridad gratis y sencillas de implementar.
  * ¿Qué es CloudFlare?¿Cómo se habilita? [(artículo)](https://www.hosting-mexico.net/clientes/knowledgebase.php?action=displayarticle&id=34)
* Evitar intentos de inicio de sesión de administrador de WordPress no autorizados [(artículo en inglés)](https://www.inmotionhosting.com/support/website/wordpress/prevent-unauthorized-wp-admin-wp-login-php-attempts)
* Forzar HTTPS SSL en WordPress [(artículo)](https://ayudawp.com/https-ssl-wordpress)
...
* ¿Por qué debes saber que son las meta-etiquetas de Open Graph? [(artículo)](https://neliosoftware.com/es/blog/debes-saber-que-son-las-meta-etiquetas-de-open-graph)
* Cómo averiguar que CMS, plantilla y plugins utiliza una web [(artículo)](https://www.webempresa.com/blog/como-averiguar-que-cms-plantilla-y-plugins-utiliza-una-web.html)
* Cómo crear una página de Facebook para tu blog [(artículo)](https://miposicionamientoweb.es/como-crear-una-pagina-de-facebook)
* Cómo espiar a tu competencia con palabras clave [(artículo)](http://www.socialancer.com/analizar-competencia-palabras-clave)
* Como incluir un widget dentro de una página o entrada [(artículo)](https://reinspirit.com/como-incluir-un-widget-dentro-de-una-pagina-o-entrada-en-wordpress)
* Cómo indexar rápido un nuevo blog wordpress en Google [(artículo)](https://carlosguerraterol.com/como-indexar-rapido-nuevo-blog-wordpress-google)
* Crear RSS específicas [(dashboard)](https://www.specificfeeds.com/get-more-readers-by-giving-them-more-choice) permite suscribirse a tus usuarios respecto a etiquetas o clasificaciones.
* Feed RSS de WordPress, el mega tutorial [(artículo)](https://ragose.com/feed-rss-wordpress-tutorial)
* [Google Analitycs](https://www.google.com/analytics) por si deseas controlar tus visitas y controlar de donde vienen, entre otros muchos más datos.
* Google Analitycs, 5 maneras diferentes de instalarlo [(artículo)](https://ignaciosantiago.com/tutorial-wordpress/instalar-codigo-google-analytics)
* Herramientas gratis de administración, Bing [(dashboard)](https://www.bing.com/toolbox/webmaster)
* Herramientas gratis de administración, Yandex [(dashboard)](https://webmaster.yandex.com)
* Herramientas gratis de SEO o posicionamiento en buscadores: [Moz Tools](https://moz.com/researchtools/ose/), [SeoBook](http://tools.seobook.com), [ScreamingFrog](https://www.screamingfrog.co.uk), [Herramientas palabras clave](https://keywordtool.io)
* [Hotjar](https://www.hotjar.com) permite supervisar tus páginas web gratuitamente; siempre que no sobrepasen las 2.000 visitas por página al día. Lo mejor, para analizar paso a paso a tus usuarios.
* [IFTTT](https://ifttt.com) la herramienta clave en las redes sociales. Permite unificar múltiples e infinitas redes sociales, generando una red casi interminable; que permite difundir tus publicaciones sin realizar trabajo innecesario.
* Las 9 mejores herramientas gratuitas para buscar keyboards [(artículo)](https://blog.hubspot.es/marketing/7-mejores-herramientas-gratuitas-para-buscar-keywords)
* Page Insights, ¿Cómo alcanzar el 100/100? [(artículo en inglés)](https://kinsta.com/blog/google-pagespeed-insights) muy buenos consejos con los que mejorar la velocidad de carga de nuestra página web.
* [Page Insights](https://developers.google.com/speed/pagespeed/insights) test de velocidad de carga de tu página
* Redireccionar Error 404 [(artículo)](https://forobeta.com/optimizacion-de-buscadores/346397-redireccionar-error-404-via-htaccess.html)
* [Search Console:](https://www.google.com/webmasters/tools/home?hl=es) herramientas de diagnóstico con las que mejorar el indexamiento de una web a los ojos de Google. Además, de mejorar su optimización enfocada en las aplicaciones móviles.
* Service Worker [(avanzado)](https://serviceworke.rs) secuencias de comandos que tu navegador ejecuta en segundo plano, en [Service Workers: introducción](https://developers.google.com/web/fundamentals/primers/service-workers/?hl=es)
* Usar "nofollow" en enlaces específicos [(documentación)](https://support.google.com/webmasters/answer/96569?hl=es)
* Usar enlaces "permalinks" [(documentación)](https://codex.wordpress.org/es:Using_Permalinks)
* [Web empresa](https://www.webempresa.com) es un blog muy conocido que lleva años trabajando con wordpress y tiene cientos de entradas tratando temas relacionados; algunas de ellas muy interesantes. Como estas sobre el SEO: 
  * Configurar SEO en WordPress (1ºparte) [(artículo)](https://www.webempresa.com/blog/configurar-seo-en-wordpress-1-parte.html)
...
* 18 Alternativas a Adsense [(artículo)](https://www.top5tecno.com/es/mejores-18-alternativas-publicidad-adsense)
* Alternativas a Adsense [(artículo)](https://comovivirdetublog.com/alternativas-a-adsense/)
* Google Adsense, ¿Cómo funciona? [(documentación)](https://www.google.es/adsense/start/how-it-works/#/)
* Google Adsense, recursos relacionados [(documentación)](https://www.google.es/adsense/start/resources/#/)
...
* Compartir en varias redes sociales nada más publicar: [NextScripts](https://es.wordpress.org/plugins/social-networks-auto-poster-facebook-twitter-g)
* Creador de botones de compartir, botones en imágenes, analítica y botones de seguimiento: [ Shareholic](https://es.wordpress.org/plugins/shareaholic)
...
* Generar tablas de contenidos dentro de una misma entrada: [Table of Contents Plus](https://es.wordpress.org/plugins/table-of-contents-plus)
  * [Documentación](https://dublue.com/plugins/toc).
* Menú: [Max Mega Menu](https://wordpress.org/plugins/megamenu)
* Menú: [Personalizado según el tipo diferente de usuarios](https://wordpress.org/plugins/nav-menu-roles)
* Menú: [Responsive Menu](https://wordpress.org/plugins/responsive-menu)
* Menú: [WP Responsive Menu](https://wordpress.org/plugins/wp-responsive-menu)
* [WP Wiki Tooltip](https://es.wordpress.org/plugins/wp-wiki-tooltip) burbujas que adquieren información directa de la Wikipedia (no aseguro que funcione).
