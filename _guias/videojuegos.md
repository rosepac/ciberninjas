...
Se dice que la última versión, [Unreal Engine 4](https://www.unrealengine.com/){:target="_blank"}, es la más fácil de usar en las herramientas manuales de un profesional. Sin embargo, hay otros motores disponibles que son más fáciles para los nuevos diseñadores.
...
<!-- https://www.gamedesigning.org/wp-content/uploads/2017/03/The-Best-Engines-to-Make-Mobile-Games-scaled.jpg -->
...
[👉 Página Oficial](https://duktape.org/){: .btn .btn--info .btn--large .align-center}{:target="_blank"}
[👉 Repositorio de Github <i class="fab fa-github"></i>](https://github.com/svaarala/duktape#duktape){: .btn .btn--info .btn--large .align-center}{:target="_blank"}
[👉 Descargar <i class="fas fa-download"></i>](https://duktape.org/download.html){: .btn .btn--info .btn--large .align-center}{:target="_blank"}

### Moddable

* [Moddable](https://www.moddable.com/){:target="_blank"}

### Otros Motores de Javascript

* [Espruino](https://github.com/espruino/Espruino){:target="_blank"} (MPL v2.0)
* [JerryScript](http://jerryscript.net/){:target="_blank"} (licencia de Apache v2.0)
* [MuJS](http://mujs.com/){:target="_blank"} (Affero LPG)
* [Quad Wheel](https://code.google.com/p/quad-wheel/){:target="_blank"} (licencia MIT)
* [QuickJS](https://bellard.org/quickjs/){:target="_blank"} (licencia MIT)
* [Tiny-js](https://github.com/gfwilliams/tiny-js){:target="_blank"} (licencia MIT)
* [v7](https://github.com/cesanta/v7){:target="_blank"} (GPL v2.0)

## Artículos sobre Motores de Videojuegos

* [Una Década en Retrospectiva y Futuro. Sobre el Motor Godot](https://godotengine.org/article/retrospective-and-future){:target="_blank"}
