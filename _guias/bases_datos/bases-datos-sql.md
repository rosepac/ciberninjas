...
- [BlazingSQL ha liberado su código fuente para el uso de GPUS para acelerar el procesamiento de datos](https://blog.desdelinux.net/blazingsql-ha-liberado-su-codigo-fuente-para-el-uso-de-gpus-para-acelerar-el-procesamiento-de-datos)

## Bases de Datos SQL

- [Blazing SQL](https://www.blazingsql.com) Motor SQL de Alto Rendimiento en GPUS
