...
- [Especificación HTML 4.01, Apéndice B.4.1](http://www.w3.org/TR/html4/appendix/notes.html#h-B.4.1.1){:target="_blank"}
- [Wikipedia - Estándar de exclusión de robots](http://en.wikipedia.org/wiki/Robots.txt){:target="_blank"}
...
La etiqueta META también se describe en [la especificación HTML 4.01, Apéndice B.4.1](http://www.w3.org/TR/html401/appendix/notes.html#h-B.4.1.2){:target="_blank"}.
...
- [Search Engine Land](http://searchengineland.com/){:target="_blank"}
- [Search Engine Watch](http://searchenginewatch.com/){:target="_blank"}
- [Mesa redonda de motores de búsqueda](http://www.seroundtable.com/){:target="_blank"}
...
- [SortSite](https://en.wikipedia.org/wiki/SortSite){:target="_blank"}
- Swiftbot es el rastreador web de [Swiftype](https://en.wikipedia.org/wiki/Swiftype){:target="_blank"} .
- [WebCrawler](https://en.wikipedia.org/wiki/WebCrawler){:target="_blank"} se utilizó para crear el primer índice de texto completo disponible públicamente de un subconjunto de la Web. Se basó en lib-WWW para descargar páginas, y otro programa para analizar y ordenar URL para una exploración más amplia del gráfico web. También incluía un rastreador en tiempo real que seguía enlaces basados en la similitud del texto de anclaje con la consulta proporcionada.
- [WebFountain](https://en.wikipedia.org/wiki/WebFountain){:target="_blank"} es un rastreador modular distribuido similar a Mercator pero escrito en C ++.
- [World Wide Web Worm](https://en.wikipedia.org/wiki/World_Wide_Web_Worm){:target="_blank"} fue un rastreador utilizado para crear un índice simple de títulos de documentos y URL. Se puede buscar el índice utilizando el `comando grep` [Unix](https://en.wikipedia.org/wiki/Unix){:target="_blank"} .
...
- [GRUB](https://en.wikipedia.org/wiki/Grub_(search_engine)){:target="_blank"} es un rastreador de búsqueda distribuida de código abierto que [Wikia Search](https://en.wikipedia.org/wiki/Wikia_Search){:target="_blank"} usó para rastrear la web.
- [Heritrix](https://en.wikipedia.org/wiki/Heritrix){:target="_blank"} es el rastreador de calidad de archivo de [Internet Archive](https://en.wikipedia.org/wiki/Internet_Archive){:target="_blank"}, diseñado para archivar instantáneas periódicas de una gran parte de la Web. Fue escrito en [Java](https://en.wikipedia.org/wiki/Java_(programming_language)){:target="_blank"}.
- [ht: // Dig](https://en.wikipedia.org/wiki/Ht-//dig){:target="_blank"} incluye un rastreador web en su motor de indexación.
- [HTTrack](https://en.wikipedia.org/wiki/HTTrack){:target="_blank"} utiliza un rastreador web para crear un espejo de un sitio web para su visualización fuera de línea. Está escrito en [C](https://en.wikipedia.org/wiki/C_(programming_language)){:target="_blank"} y publicado bajo la [GPL](https://en.wikipedia.org/wiki/GNU_General_Public_License){:target="_blank"}.
- [mnoGoSearch](https://en.wikipedia.org/wiki/MnoGoSearch){:target="_blank"} es un rastreador, indexador y un motor de búsqueda escrito en C y con licencia bajo la [GPL](https://en.wikipedia.org/wiki/GNU_General_Public_License){:target="_blank"} (* solo máquinas NIX)
- [Norconex HTTP Collector](https://en.wikipedia.org/wiki/Norconex_HTTP_Collector){:target="_blank"} es una araña web, o rastreador, escrita en [Java](https://en.wikipedia.org/wiki/Java_(programming_language)){:target="_blank"} , que tiene como objetivo facilitar la vida de los integradores y desarrolladores de Enterprise Search (con licencia de [Apache License](https://en.wikipedia.org/wiki/Apache_License){:target="_blank"}.
- [Apache Nutch](https://en.wikipedia.org/wiki/Apache_Nutch){:target="_blank"} es un rastreador web altamente extensible y escalable escrito en Java y lanzado bajo una [licencia de Apache](https://en.wikipedia.org/wiki/Apache_License){:target="_blank"}. Está basado en [Apache Hadoop](https://en.wikipedia.org/wiki/Apache_Hadoop){:target="_blank"} y puede usarse con [Apache Solr](https://en.wikipedia.org/wiki/Apache_Solr){:target="_blank"} o [Elasticsearch](https://en.wikipedia.org/wiki/Elasticsearch){:target="_blank"}.
- [Open Search Server](https://en.wikipedia.org/wiki/Open_Search_Server){:target="_blank"} es un motor de búsqueda y una versión de software de rastreador web bajo la [GPL](https://en.wikipedia.org/wiki/GNU_General_Public_License){:target="_blank"}.
- [PHP-Crawler](https://en.wikipedia.org/wiki/PHP-Crawler){:target="_blank"} es un simple rastreador basado en [PHP](https://en.wikipedia.org/wiki/PHP){:target="_blank"} y [MySQL](https://en.wikipedia.org/wiki/MySQL){:target="_blank"} lanzado bajo la [Licencia BSD](https://en.wikipedia.org/wiki/BSD_License){:target="_blank"}.
- [Scrapy](https://en.wikipedia.org/wiki/Scrapy){:target="_blank"}, un framework de [webcrawler de](https://en.wikipedia.org/wiki/Scrapy){:target="_blank"} código abierto, escrito en python (licenciado bajo [BSD](https://en.wikipedia.org/wiki/BSD_License){:target="_blank"}.
- [Seeks](https://en.wikipedia.org/wiki/Seeks){:target="_blank"}, un motor de búsqueda distribuido gratuito (con licencia [AGPL](https://en.wikipedia.org/wiki/GNU_Affero_General_Public_License){:target="_blank"}.
- [StormCrawler](https://en.wikipedia.org/wiki/StormCrawler){:target="_blank"}, una colección de recursos para crear rastreadores web escalables y de baja latencia en [Apache Storm](https://en.wikipedia.org/wiki/Storm_(event_processor)){:target="_blank"} ( [licencia de Apache](https://en.wikipedia.org/wiki/Apache_License){:target="_blank"} ).
- [tkWWW Robot](https://en.wikipedia.org/wiki/TkWWW_Robot){:target="_blank"}, un rastreador basado en el navegador web [tkWWW](https://en.wikipedia.org/wiki/TkWWW){:target="_blank"} (con licencia bajo [GPL](https://en.wikipedia.org/wiki/GNU_General_Public_License){:target="_blank"} ).
