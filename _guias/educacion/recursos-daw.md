...
[**OpenLibra: Ejercicios de Programación en Java**](https://openlibra.com/es/book/download/ejercicios-de-programacion-en-java)
...
* [**OpenLibra: Programación Orientada a Objetos en Java**](https://openlibra.com/es/book/download/programacion-orientada-a-objetos-en-java)
...
* [**PDF de programación - Notas de Introducción al Lenguaje de Programación Java**](https://www.lawebdelprogramador.com/pdf/1905-Notas-de-Introduccion-al-Lenguaje-de-Programacion-Java.html)
...
* [**OpenLibra: Piensa en Java (Edición española)**](https://openlibra.com/es/book/piensa-en-java-edicion-espanola)
...
* [**OpenLibra: CSS3 y Javascript avanzado**](https://openlibra.com/es/book/download/css3-y-javascript-avanzado)

> En este manual proveniente de la UOC se analizan dos de las tecnologías más punteras en cuanto al desarrollo web (CSS3)

HTML5. ArkaitzGarro

* [**HTML5**](https://www.arkaitzgarro.com/html5/index.html)

CSS3. ArkaitzGarro

* [**CSS 3**](https://www.arkaitzgarro.com/css3/)
...
* [**English for Information Technology, an online course**](https://www.english4it.com/)
...
* [**Introducción a JavaScript**
*1.4. Cómo incluir JavaScript en documentos XHTML*librosweb.es](https://uniwebsidad.com/libros/javascript)

Jardín de JavaScript

* [**Jardín de JavaScript**](http://bonsaiden.github.io/JavaScript-Garden/es/#intro)
...
* [**AJAX**](https://www.arkaitzgarro.com/ajax/)
...
* [**Administración de servidores web](https://javiergarciaescobedo.es/despliegue-de-aplicaciones-web/81-administracion-de-servidores-web)

### Servidores de Aplicaciones

* [**Servidores de aplicaciones](https://javiergarciaescobedo.es/despliegue-de-aplicaciones-web/86-servidores-de-aplicaciones)

### Arquitecturas Web

* [**Implantación de Arquitecturas Web](https://javiergarciaescobedo.es/despliegue-de-aplicaciones-web/76-arquitecturas-web)
...
* [**Teoría Unidad 1 - Planificación de interfaces web**](http://interfacesweb.github.io/unidades/01-planificacion/index.html)

> Fundamentos del Diseño Web. Basado en el libro Don't make me think de Steven Krug.

Tema 2 . Estilos

* [**Teoría Unidad 2 - Estilos**](http://interfacesweb.github.io/unidades/02-estilos/index.html)

> Hojas de estilos. Responsive Design. Bootstrap.*interfacesweb.github.io

**Guías de Estilos**

1. [Ejemplo. 1](http://www.upv.es/entidades/ASIC/manuales/guia_estilos_upv.pdf) (Web de la Excma. Universidad de Valencia)
2. [Ejemplo. 2](https://editorial.ugr.es/pages/calidad/guiadeestilo/!) (Web de la Excma. Universidad de Granada)
