...
* [Cursos de la Academia Microsoft](/cursos-tecnologia-microsoft/){:target="_blank" rel="nofollow,noreferrer"} [^1]
...
* [Introducción a Laravel 5: primeros pasos con este framework](https://www.udemy.com/introduccion-a-laravel-5-primeros-pasos-framework-php){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
...
* [Taller de creación de Backdoors con Python - Parte 1](https://www.udemy.com/course/backdoors-with-python){:target="_blank" rel="nofollow,noreferrer"} (Udemy) (2019)
* [TensorFlow para Deep Learning y Python](https://www.udemy.com/course/curso-de-tensorflow-para-deep-learning-y-python){:target="_blank" rel="nofollow,noreferrer"}
...
* [Introducción a Excel 2010](https://www.udemy.com/introduccion-a-excel-2010){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
...
* [Aprende a usar Google Drive de una manera fácil y sencilla](https://www.udemy.com/aprende-a-usar-google-drive-de-una-manera-facil-y-sencilla){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Domina la hoja de cálculo de Google sin esfuerzo](https://www.udemy.com/domina-la-hoja-de-calculo-de-google-sin-esfuerzo){:target="_blank" rel="nofollow,noreferrer"} (Udemy)

### Presentaciones

* [Cómo hacer screenshots para tus APPS de manera fácil](https://www.udemy.com/como-hacer-screenshots-para-tus-apps-de-manera-facil){:target="_blank" rel="nofollow,noreferrer"} (Udemy)

### Historia Informática

* [Computación básica desde cero](https://www.udemy.com/computacion-basica-desde-cero-hasta-redes-sociales){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
...
* [Informática desde Cero](https://www.udemy.com/informatica-desde-cero){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
...
* [Informática Aplicada a la Gestión Pública](https://www.udemy.com/introduccion-a-outlook-2010){:target="_blank" rel="nofollow,noreferrer"} (Universidad de Murcia) (2011)
* [Introducción a Outlook 2010](https://www.udemy.com/introduccion-a-outlook-2010){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
...
* [Componente HorizontalArrangement](https://www.udemy.com/app-inventor-y-su-componente-horizontalarrangement){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Componente Polygon](https://www.udemy.com/app-inventor-2-componente-polygon){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Componente SoundRecorder](https://www.udemy.com/curso-del-componente-soundrecorder-de-app-inventor){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Componente Yandex. Translate](https://www.udemy.com/app-inventor-2-componente-yandextranslate){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Descubre Rectangle](https://www.udemy.com/componente-rectangle-maps-app-inventor){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Dragged y Flung](https://www.udemy.com/app-inventor-a){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Ev3 Commands y App Inventor](https://www.udemy.com/ev3-commands){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [ImagePicker](https://www.udemy.com/appinvento2-imagepicker){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [ListView](https://www.udemy.com/app-inventor-listview){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [NxtLightSensor](https://www.udemy.com/app-inventor-2-nxtlightsensor){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Slider e Introducción](https://www.udemy.com/slider-introduccion-a-appinventor){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
* [Videoplayer](https://www.udemy.com/app-inventor-2-videoplayer){:target="_blank" rel="nofollow,noreferrer"} (Udemy)
