---
# Página Base
title: "🥇 ▷ Los Mejores Libros PDF de PROGRAMACIÓN para aprender a DESARROLLAR aplicaciones en 2020 📚"
...
date: 2020-5-07T22:00:00.000+00:00
last_modified_at:
...
* [Biblioteca Virtual: Miguel de Cervantes](https://www.cervantesvirtual.com){:target="_blank"}
...
* [TLDP: servicios editoriales para la documentación libre en español (2007)](https://es.tldp.org/index.html){:target="_blank"} (CICA)
...
* [Style Guides](https://styleguides.io){:target="_blank"} (+572 entre Artículos, Libros y Herramientas)
...
* [Base de Datos (2005)](https://www.uoc.edu/masters/oficiales/img/913.pdf){:target="_blank"} - Mercedes Marqués (PDF)
...
* [Breves Notas sobre Autómatas y Lenguajes](https://lya.fciencias.unam.mx/jloa/publicaciones/automatasyLenguajes.pdf){:target="_blank"} (PDF)
* [Breves Notas sobre Teoría de la Computación](https://lya.fciencias.unam.mx/jloa/publicaciones/teoria.pdf){:target="_blank"} (PDF)
* [Conceptos elementales de computadores](https://lorca.act.uji.es/libro/conceptos_elementales_de_computadores.pdf){:target="_blank"} (PDF)
...
* [Industria 4.0: Tendencias de la literatura académica reciente](https://revistaespacios.com/a19v40n30/a19v40n30p27.pdf){:target="_blank"} (2019) (PDF)
* [Introducción al pensamiento computacional: Conceptos básicos para todos](https://amexcomp.mx/files/libro/LibroPC.pdf){:target="_blank"} (PDF)
...
* [La Cuarta Revolución Industrial: Un relato desde el materialismo cultural](https://repositorio.ual.es/bitstream/handle/10835/4809/LA%20CUARTA%20REVOLUCION%20INDUSTRIAL.pdf){:target="_blank"} (2016) (PDF)
...
* [Algoritmos y Programación (Guía para docentes)](https://www.eduteka.org/pdfdir/AlgoritmosProgramacion.pdf){:target="_blank"} (PDF)
...
* [Breves Notas sobre Análisis de Algoritmos](https://lya.fciencias.unam.mx/jloa/publicaciones/analisisdeAlgoritmos.pdf){:target="_blank"} (PDF)
* [DevOps: La Perspectiva de las Operaciones](https://leanpub.com/devops-the-ops-perspective-spanish?){:target="_blank"} (PDF)
* [Fundamentos de Informática y Programación](https://robotica.uv.es/Libro/Indice.html){:target="_blank"} (HTML)
* [Fundamentos de la Programación](https://www.fdi.ucm.es/profesor/luis/fp/FP.pdf){:target="_blank"} (PDF)
* [Introducción al desarrollo del software](https://softlibre.unizar.es/manuales/linux/reference.es.pdf){:target="_blank"} (PDF)
...
* [Aspectos legales de explotación del software libre. Parte II](https://softlibre.unizar.es/manuales/legal/909.pdf){:target="_blank"} (PDF)
...
* [Copia este libro](https://www.rebelion.org/docs/23824.pdf){:target="_blank"} (PDF)
* [Copyleft: la creación se promueve... compartiéndola](https://www.sindominio.net/~xabier/old/textos/copyleft/copyleft.pdf){:target="_blank"} (PDF)
* [Guía básica del software de fuentes abiertas](https://softlibre.unizar.es/manuales/softwarelibre/guia_basica_sfa.pdf){:target="_blank"} (PDF)
* [Guía práctica sobre software libre. Su selección y aplicación local en América Latina y el Caribe](https://softlibre.unizar.es/manuales/softwarelibre/GSL_UNESCO.pdf){:target="_blank"} (PDF)
...
* [La catedral y el bazar](https://softlibre.unizar.es/manuales/softwarelibre/catedralbazar.pdf){:target="_blank"} (PDF)
...
* [La definición de Software Libre](https://softlibre.unizar.es/manuales/softwarelibre/free-sw.es.pdf){:target="_blank"} (PDF)
* [Libro blanco del Software Libre en España III](https://softlibre.unizar.es/manuales/softwarelibre/III_libro_blanco_del_software_libre.pdf){:target="_blank"} (PDF)
* [Metabolismo, comunicación y evolución en redes bacterianas y tecnológicas](https://www.sindominio.net/~xabier/old/textos/autobact/autobact.pdf){:target="_blank"} (PDF)
...
* [Sistema Operativo GNU/Linux Básico](https://softlibre.unizar.es/manuales/linux/868.pdf){:target="_blank"} (PDF)
...
* [Software libre: técnicamente viable, económicamente sostenible y socialmente justo](https://www.infonomia.com/img/pdf/llibrejmas.pdf){:target="_blank"} (PDF)
* [Software libre vs software propietario. Ventajas y desventajas](https://www.rebelion.org/docs/32693.pdf){:target="_blank"} (PDF)
...
* [Bases de la programación en Bash](https://xinfo.sourceforge.net/documentos/bash-scripting/bash-script-2.0.html){:target="_blank"} (HTML)
* [BASH Scripting Avanzado: Utilizando declare para definición de tipo](https://web.archive.org/web/20150307181233/https://library.originalhacker.org:80/biblioteca/articulo/ver/123){:target="_blank"} (PDF)(descarga directa)
...
* [Guía de instalación de Debian GNU/Linux (2007)](https://softlibre.unizar.es/manuales/linux/install.es.pdf){:target="_blank"} (PDF)
* [Guía de instalación de Debian GNU/Linux (2017)](https://www.debian.org/releases/stable/i386/install.pdf.es){:target="_blank"} (PDF)
* [Guía de referencia Debian](https://softlibre.unizar.es/manuales/linux/reference.es.pdf){:target="_blank"} (PDF)
* [Guía de referencia rápida Debian](https://softlibre.unizar.es/manuales/linux/quick-reference.es.pdf){:target="_blank"} (PDF)
* [Guía del nuevo desarrollador de Debian (2007)](https://softlibre.unizar.es/manuales/linux/maint-guide.es.pdf){:target="_blank"} (PDF)
...
* [Sistema Operativo Huayra Gnu/Linux](https://bibliotecadigital.educ.ar/articles/read/366){:target="_blank"} (HTML)
...
* [97 cosas que todo programador debería saber](https://97cosas.com/programador){:target="_blank"} (HTML)
...
* [Guía de Referencia de Scratch 2.0](https://lsi.vc.ehu.es/pablogn/docencia/FdI/Scratch/ScratchGuiaReferencia.pdf){:target="_blank"} (PDF)
* [Manual de Scratch](https://lsi.vc.ehu.es/pablogn/docencia/FdI/Scratch/manual%20scratch.pdf){:target="_blank"} (PDF)
...
* [Determinación de aspectos clave de la seguridad de la información, procesos informáticos y recursos tecnológicos](https://revistaespacios.com/a19v40n30/a19v40n30p22.pdf){:target="_blank"}
...
realidad social](https://www.sindominio.net/~xabier/old/textos/hl/hl.pdf){:target="_blank"} (PDF)
...
* [Seguridad en aplicaciones web](https://openaccess.uoc.edu/webapps/o2/bitstream/10609/33721/6/isidoro_ciervaTFM0614memoria.pdf){:target="_blank"} (PDF)
...
* [Aulas en red. Aplicaciones y servicios. Linux](https://www.ite.educacion.es/formacion/materiales/85/cd/linux/indice.htm){:target="_blank"}
* [Aulas en red. Aplicaciones y servicios. Windows](https://www.ite.educacion.es/formacion/materiales/85/cd/windows/indice.htm){:target="_blank"}
* [Redes. Contenido de Cisco: CCNA](https://nksistemas.com/curso-de-redes-online-contenidos-de-ccna){:target="_blank"} (HTML)
...
* [Aprendemos a manejar el computador (2009)](https://www.iered.org/archivos/Publicaciones_Libres/2009_Aprendamos_Manejo_Computador/Manejo-Computador_Texto_v4.pdf){:target="_blank"} (PDF)
...
* [Fundamentos de Sistemas Operativos](https://sistop.org/pdf/sistemas_operativos.pdf){:target="_blank"} - Gunnar Wolf et al (PDF)
* [Iniciación al software libre: OpenOffice](https://softlibre.unizar.es/manuales/softwarelibre/Manual_zaragoza_alta.pdf){:target="_blank"} (PDF)
* [Mantenimiento de computadoras (2011)](https://www.iered.org/archivos/Publicaciones_Libres/2011_Mantenimiento_Computadores/MantenimientoDeComputadores.pdf){:target="_blank"} (PDF)
...
* [Avances en Sistemas e Informática](https://www.redalyc.org/revista.oa?id=1331){:target="_blank"} (HTML)
...
* [Ciencias de la Información (8 revistas)](https://www.redalyc.org/area.oa?id=23&tipo=coleccion&bJats=1){:target="_blank"}
* [Computación y Sistemas](https://www.redalyc.org/revista.oa?id=615){:target="_blank"} (HTML)
* [Espacios](https://www.revistaespacios.com/indice.html){:target="_blank"} (PDF) (HTML)
* [Estudios Urbanos y Ciencias Sociales](https://www2.ual.es/urbs/index.php/urbs/issue/archive){:target="_blank"} (PDF)
* [Gerencia Tecnológica Informática (2015)](https://dialnet.unirioja.es/servlet/revista?codigo=11969){:target="_blank"}
* [Iberoaméricana de las Ciencias Computacionales e Informática](https://www.reci.org.mx/index.php/reci/issue/archive){:target="_blank"} (HTML)
* [Información, Tecnología y Conocimiento: "Enlace"](https://dialnet.unirioja.es/servlet/revista?codigo=7671){:target="_blank"} (HTML)
* [Innovación, Calidad e Ingeniería del Software](https://www.redalyc.org/revista.oa?id=922){:target="_blank"} (HTML)
...
* [Curso Android](https://www.hermosaprogramacion.com/android){:target="_blank"} (HTML)
...
* [Bootstrap 3, el manual oficial](https://librosweb.es/libro/bootstrap_3){:target="_blank"} (HTML)
...
* [Ejercicios de programación creativos y recreativos en C++](https://antares.sip.ucm.es/cpareja/libroCPP/){:target="_blank"} (HTML)
* [Fundamentos de Programación con el Lenguaje de Programación C++ (2017)](https://www.lcc.uma.es/~vicente/docencia/cppdoc/programacion_cxx.pdf){:target="_blank"} (PDF)
...
* [Git. La guía simple](https://rogerdudler.github.io/git-guide){:target="_blank"} (HTML)
* [Gitmagic](https://www-cs-students.stanford.edu/~blynn/gitmagic/intl/es){:target="_blank"}
* [Pro Git](https://git-scm.com/book/es/){:target="_blank"}
...
* [Estructura con CSS](https://es.learnlayout.com){:target="_blank"} (HTML)
* [Guía Completa de CSS3](https://openlibra.com/es/book/download/guia-completa-de-css3){:target="_blank"} - Antonio Navajas (PDF)
* [HTML5](https://www.arkaitzgarro.com/html5){:target="_blank"} - Arkaitz Garro (HTML) [(PDF)](https://openlibra.com/es/book/download/html5){:target="_blank"}
* [Introducción a CSS](https://librosweb.es/libro/css/){:target="_blank"} - Javier Eguíluz (HTML) [(PDF)](https://openlibra.com/es/book/download/introduccion-a-css){:target="_blank"}
...
* [Aprendiendo Java y POO (2008)](https://www.decom-uv.cl/~roberto/apuntes/java/AprendiendoJava.pdf){:target="_blank"} (PDF)
* [Desarrollo de proyectos informáticos con Java](https://www3.uji.es/~belfern/libroJava.pdf){:target="_blank"} (PDF)
...
* [Notas de Introducción al Lenguaje de Programación Java (2004)](https://lya.fciencias.unam.mx/jloa/publicaciones/introduccionJava.pdf){:target="_blank"} - Jorge L. Ortega Arjona (PDF)
* [Pensando la computación como un científico (con Java)](https://www.ungs.edu.ar/cm/uploaded_files/publicaciones/476_cid03-Pensar%20la%20computacion.pdf){:target="_blank"} (PDF)
...
* [Programación en Java](https://elvex.ugr.es/decsai/java){:target="_blank"} (HTML)
...
* [Jardín de JavaScript](https://bonsaiden.github.io/JavaScript-Garden/es){:target="_blank"} (HTML)
...
* [Cómo aprender AngularJS](https://raulexposito.com/documentos/como-aprender-angularjs){:target="_blank"} (HTML)

### D3.js

* [Tutorial de D3](https://gcoch.github.io/D3-tutorial/index.html){:target="_blank"} (HTML)
...
* [Manual de jQuery](https://mundosica.github.io/tutorial_hispano_jQuery/){:target="_blank"} (HTML)

### Node <i class="fab fa-node-js"></i>

* [Introducción a Node.js a través de Koans](https://nodejskoans.com){:target="_blank"}
* [Tutorial para Principiantes en Node.js](https://www.nodebeginner.org/index-es.html){:target="_blank"}
...
* [Manual de estudio introductorio al lenguaje PHP procedural](https://web.archive.org/web/20140209203630/https://www.cursosdeprogramacionadistancia.com/static/pdf/material-sin-personalizar-php.pdf){:target="_blank"} (PDF)
...
* [POO y MVC en PHP](https://www.bubok.es/libros/205199/POO-y-MVC-en-PHP){:target="_blank"} (Bubok)
* [Programación PHP](https://www.matpec.com.ar/desde0/desde0-programacion-php-6.htm){:target="_blank"} (HTML)
* [Programación web avanzada: ajax y google maps](https://rua.ua.es/dspace/bitstream/10045/13176/9/04-ajaxphp.pdf){:target="_blank"} (PDF)
* [Silex, el manual oficial](https://librosweb.es/libro/silex){:target="_blank"} (HTML) 
* [Symfony 1.4, la guía definitiva](https://librosweb.es/libro/symfony_1_4){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/symfony-la-guia-definitiva){:target="_blank"}
* [Symfony 2.4, el libro oficial](https://librosweb.es/libro/symfony_2_4/){:target="_blank"} (HTML) [(PDF)](https://openlibra.com/es/book/download/manual-de-symfony2-ver-2-0-12){:target="_blank"}
...
* [La programación de Perl para Unix (1997)](https://www.el.bqto.unexpo.edu.ve/~jaguero/docs/varios/perlMexico.pdf){:target="_blank"} (PDF)
* [Tutorial Perl](https://es.tldp.org/Tutoriales/PERL/tutoperl-print.pdf){:target="_blank"} (PDF)
* [Tutorial Perl](https://kataix.umag.cl/~ruribe/Utilidades/Tutorial%20de%20Perl.pdf){:target="_blank"} (PDF)
* [Tutoriales de Perl](https://perlenespanol.com/tutoriales/){:target="_blank"} (HTML)
...
* [Ruby tutorial o como pasar un buen rato programando](https://rubytutorial.wikidot.com/introduccion){:target="_blank"} (HTML)


### Ruby on Rails

* [Introducción a Rails](https://rubysur.org/introduccion.a.rails){:target="_blank"} (Gitbook) (2015)
* [Introducción a Ruby on Rails](https://librosweb.es/libro/introduccion_rails){:target="_blank"} (HTML)


## R

* [Cartas sobre Estadística de la Revista Argentina de Bioingeniería](https://cran.r-project.org/doc/contrib/Risk-Cartas-sobre-Estadistica.pdf){:target="_blank"} (PDF)
* [Generacion automática de reportes con R y LaTeX](https://cran.r-project.org/doc/contrib/Rivera-Tutorial_Sweave.pdf){:target="_blank"} (PDF)
* [Gráficos Estadísticos con R](https://cran.r-project.org/doc/contrib/grafi3.pdf){:target="_blank"} (PDF)
* [Introducción a R](https://cran.r-project.org/doc/contrib/R-intro-1.1.0-espanol.1.pdf){:target="_blank"} (PDF)
* [Introducción al uso y programación del sistema estadístico R](https://cran.r-project.org/doc/contrib/curso-R.Diaz-Uriarte.pdf){:target="_blank"} (PDF)
* [Métodos Estadísticos con R y R Commander](https://cran.r-project.org/doc/contrib/Saez-Castillo-RRCmdrv21.pdf){:target="_blank"} (PDF)
* [Optimización Matemática con R: Volúmen I](https://cran.r-project.org/doc/contrib/Optimizacion_Matematica_con_R_Volumen_I.pdf){:target="_blank"} (PDF)
* [Programación en R del método de las palabras asociadas](https://www.docentes.unal.edu.co/cepardot/docs/TrabajosGrado/TrabajoGrado_Daniel.pdf){:target="_blank"} (PDF)
* [R para Principiantes](https://cran.r-project.org/doc/contrib/rdebuts_es.pdf){:target="_blank"} (PDF)


## Scala

* [Manual de Scala para programadores Java](https://www.scala-lang.org/docu/files/ScalaTutorial-es_ES.pdf){:target="_blank"} (PDF) (2007)
...
* [¿Alergia al LaTeX? (2000)](https://www.sindominio.net/ayuda/latex/sdlatex.pdf){:target="_blank"} (PDF)
* [¿Qué es TeX?](https://www.cervantex.es/queestex){:target="_blank"}
...
* [Guía rápida de LaTeX (2014)](https://nokyotsu.com/latex/guia.html){:target="_blank"}
* [Introducción a LaTeX (2004)](https://www.sindominio.net/~xabier/old/curso_latex){:target="_blank"} (HTML)
* [La introducción no-tan-corta a LaTeX 2ε](https://osl.ugr.es/CTAN/info/lshort/spanish/lshort-a4.pdf){:target="_blank"} (PDF)
* [LaTeX para las humanidades](https://rt0016xp.eresmas.net/lplh/latex-humanidades.pdf){:target="_blank"} (PDF)
* [LaTeX: Procesamiento de textos científicos en alta calidad (2011)](HTML)
* [TeXemplares: Boletín de CervanTEX](https://www.cervantex.es/files/cervantex/texemplares9.pdf){:target="_blank"} (PDF)
...
* [Programación de videojuegos SDL](https://libros.metabiblioteca.org/bitstream/001/271/8/Programacion_Videojuegos_SDL.pdf){:target="_blank"} (PDF)
...
* [Informe de Accesibilidad Web Defensa.Gob.Es](https://www.defensa.gob.es/rapfas/Galerias/ficheros/Informe_de_accesibilidad_enero_2018.pdf){:target="_blank"} (2018)
* [Metodología del Observatorio de Accesbilidad Web UNE](https://www.defensa.gob.es/rapfas/Galerias/ficheros/Metodologia_Observatorio_Accesibilidad_Web-UNE2012-v1_0.pdf){:target="_blank"} (2012)
* [Proceso de validación nivel de accesibilidad web en sitios del Gobierno en línea del estado Colombiano](https://www.revistaespacios.com/a18v39n48/a18v39n48p08.pdf){:target="_blank"}
